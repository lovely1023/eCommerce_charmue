...
class Init {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'popper', $this->url . 'assets/js/popper.min.js', ['jquery'], \ElementsKit::version(), true );
		wp_enqueue_script( 'tippyjs', $this->url . 'assets/js/tippy.min.js', ['jquery'], \ElementsKit::version(), true );
		wp_enqueue_script( 'ekit-adv-tooltip', $this->url . 'assets/js/init.js', ['jquery', 'elementor-frontend'], \ElementsKit::version(), true );
	}
}

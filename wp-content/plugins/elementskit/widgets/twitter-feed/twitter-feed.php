...
class ElementsKit_Widget_Twitter_Feed extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Show Header', 'elementskit-lite' ),
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Show Cover Photo', 'elementskit-lite' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'elementskit-lite' ),
                'label_off' => esc_html__( 'Hide', 'elementskit-lite' ),
                'return_value' => 'yes',
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Show Statics', 'elementskit-lite' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'elementskit-lite' ),
                'label_off' => esc_html__( 'Hide', 'elementskit-lite' ),
                'return_value' => 'yes',
		 ...
		 $this->add_control(
            ...
            [
                ...
                'options' => [
                    'ekit-layout-list'  => esc_html__( 'List', 'elementskit-lite' ),
                    'ekit-layout-grid' => esc_html__( 'Grid', 'elementskit-lite' ),
                    'ekit-layout-masonary' => esc_html__( 'Masonary', 'elementskit-lite' ),
		...
		$this->add_control(
            ...
            [
                ...
                'default' => 'ekit-col-4',
                'options' => [
                    'ekit-col-6'  => esc_html__( '2 Columns', 'elementskit-lite' ),
                    'ekit-col-4' => esc_html__( '3 Columns', 'elementskit-lite' ),
                    'ekit-col-3' => esc_html__( '4 Columns', 'elementskit-lite' ),
                ],
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Show Media', 'elementskit-lite' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'elementskit-lite' ),
                'label_off' => esc_html__( 'Hide', 'elementskit-lite' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'default' =>esc_html__( 'Follow', 'elementskit-lite' ),
                'placeholder' =>esc_html__( 'Follow', 'elementskit-lite' ),
				'separator' => 'before',
            ]
        );
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Show Author', 'elementskit-lite' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'elementskit-lite' ),
                'label_off' => esc_html__( 'Hide', 'elementskit-lite' ),
                'return_value' => 'yes',
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Author Settings', 'elementskit-lite' ),
                'type' =>  Controls_Manager::SELECT,
                'default' => 'both',
                'options' => [
                    'only-profile'  => esc_html__( 'Only Thumbnail Image', 'elementskit-lite' ),
                    'only-name' => esc_html__( 'Only Name', 'elementskit-lite' ),
                    'both' => esc_html__( 'Both Thumbnail & name', 'elementskit-lite' ),
                ],
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Thumbnail Style', 'elementskit-lite' ),
                'type' =>  Controls_Manager::SELECT,
                'default' => 'ekit-twitter-profile-circle',
                'options' => [
                    'ekit-twitter-profile-circle'  => esc_html__( 'Circle', 'elementskit-lite' ),
                    'ekit-twitter-profile-square' => esc_html__( 'Square', 'elementskit-lite' ),
                ],
				'condition' => [
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Show Hash', 'elementskit-lite' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'elementskit-lite' ),
                'label_off' => esc_html__( 'Hide', 'elementskit-lite' ),
                'return_value' => 'yes',
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Comments Box', 'elementskit-lite' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Show', 'elementskit-lite' ),
                'label_off' => esc_html__( 'Hide', 'elementskit-lite' ),
                'return_value' => 'yes',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Cover Photo', 'elementskit-lite' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Statics', 'elementskit-lite' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' =>esc_html__( 'Count Color', 'elementskit-lite' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#abb8c2',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Permalink Color', 'elementskit-lite' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#D55732',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Hash Tag', 'elementskit-lite' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__( 'Action', 'elementskit-lite' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Comments', 'elementskit-lite' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Retweet', 'elementskit-lite' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Like', 'elementskit-lite' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Play Button', 'elementskit-lite' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Circle Color', 'elementskit-lite' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#1DA1F2',
				'selectors' => [
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Play Color', 'elementskit-lite' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#ffffff',
				'selectors' => [
			...
			<div class="ekit-twitter-user-timeline">
				...
				<div class="ekit-twitter-feed-profile-info-wraper">
					...
					<div class="ekit-twitter-feed-header-statistics">
						<p class="ekit-twitter-tweet-count"><?php esc_html_e('Tweets', 'elementskit-lite');?> <strong><?php echo esc_html($tweet_count);?></strong></p>
						<p class="ekit-twitter-tweet-count"> <?php esc_html_e('Following', 'elementskit-lite');?><strong><?php echo esc_html($following_count);?></strong></p>
						<p class="ekit-twitter-tweet-count"><?php esc_html_e('Followers', 'elementskit-lite');?> <strong><?php echo esc_html($followers_count);?></strong></p>
						<p class="ekit-twitter-tweet-count"><?php esc_html_e('Likes', 'elementskit-lite');?> <strong><?php echo esc_html($fav_count);?></strong></p>
					</div>
		   			<?php endif; ?>
								...
								<div class="ekit-twitter-feed-column <?php echo esc_attr($columnFeed); ?>">
									<div class="ekit-twitter-feed-content-wraper">
										...
										<div class="read-more-button">
											<a href="<?php echo esc_url('https://twitter.com/statuses/' . $twitter['id_str']); ?>" target="_blank"> <?php esc_html_e('More', 'elementskit-lite'); ?> </a>
										</div>
										<?php endif;?>
										<!--End read more-->

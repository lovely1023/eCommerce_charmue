            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        'numbered'      => esc_html__( 'Numbered', 'elementskit-lite' ),
                        'loadmore'     => esc_html__( 'Load More', 'elementskit-lite' )
                    ],
                    'default' => 'simple',
                    'condition' => [
    ...
    $this->add_responsive_control(
       ...
       $this->start_controls_section(
        ...
        $this->add_control(
            'pagination_color',
            [
                'label' => esc_html_x( 'Text Color', 'Border Control', 'elementskit-lite' ),
                'type' => Controls_Manager::COLOR,
                'default' => '#505255',
                'selectors' => [

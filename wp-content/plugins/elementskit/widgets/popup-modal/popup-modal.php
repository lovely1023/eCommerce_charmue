...
class ElementsKit_Widget_Popup_Modal extends Widget_Base
{
    ...
    private function control_section_layout() {
        ...
        $this->add_control( 'toggle_after', [
            'label' => __( 'Toggle After (Seconds)', 'elementskit' ),
    ...
    protected function _register_controls() {
		...
		$this->add_responsive_control( 'footer_buttons_alignment', [
            ...
            'default' => 'flex-end',
            'separator'    => 'before',
            'description' => __('it will work reverse if `Reverse Order` is enabled.', 'elementskit'),
            'options' => [
                'flex-start'    => [
                    'title' =>esc_html__( 'Left', 'elementskit' ),
                    'icon' => 'fa fa-align-left',
    ...
    protected function render_raw()
    {
        ...
        <!-- Start Markup -->
            ...
            <!-- Modal -->
            <div 
                class="<?php echo $popup_classes ?>" 
                data-toggleafter="<?php echo $toggle_after; ?>"
                data-toggletype="<?php echo $toggler_type; ?>"
                data-cookieconsent="<?php if($enable_cookie_consent=='yes') echo esc_attr( $this->get_id() ); ?>"
            >
                <?php if($close_btn_window): ?>
                    <div class="ekit-popup-modal__close ekit-popup__close ekit-popup__close-btn <?php echo $close_btn_position ?>">
                ...
                <div
                    ...
                    style="<?php echo $outside_position_style ?>"
                    data-animation="<?php echo !empty($inside_animation) ? $inside_animation : '' ?>"
                >
                    <?php if($close_btn_popup): ?>
                        <div class="ekit-popup-modal__close <?php echo $close_btn_position ?>">
                            <?php Icons_Manager::render_icon( 
                                $close_button_icons, [
                                    'aria-hidden' => 'true'
                                ]
                    ...
                    <!-- Start Header -->
                    <?php if($show_header): ?>
                        <div class="ekit-popup-modal__header ekit-popup__header <?php echo $header_divider ?>">
                    ...
                    <!-- Start Footer -->
                    <?php if($show_footer): ?>
                        <div class="ekit-popup-modal__footer ekit-popup-footer<?php echo $footer_divider ?>">
                            <div 
                                ...
                                <?php if($show_footer_close == "yes"): ?>
                                    <span>
                                        <a 
                                            href="#" 
                                            class="elementskit-btn ekit-popup-btn ekit-popup-footer__close whitespace--normal <?php echo $footer_close_type ?>"
                                            ><?php echo $footer_close_text; ?>
                                        </a>
                                    </span>
                                <?php endif; ?>
                                <?php if($show_footer_cta == "yes"): ?>
                                    <span>
                                        <a 
                                            href="<?php echo !empty($footer_cta_url) ? $footer_cta_url : '#' ?>" 
                                            class="elementskit-btn ekit-popup-btn ekit-popup__cta whitespace--normal <?php echo $footer_cta_type ?>"
                ...
                <?php if($show_overlay): ?>
                    <div class="<?php echo $overlay_classes ?>"></div>
                <?php endif; ?>
            </div>
        <!-- End Markup -->
    <?php }}?>
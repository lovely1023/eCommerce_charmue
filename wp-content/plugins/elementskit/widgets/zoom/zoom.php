...
class ElementsKit_Widget_Zoom extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__('Enable Protected?', 'elemenetskit'),
		...
		$this->add_control(
			...
			[
				'label'       => esc_html__('Enable Count Down Timer?', 'elemenetskit'),
				'type'        => Controls_Manager::SWITCHER,
				'label_on'    => esc_html__('Show', 'elemenetskit'),
				'label_off'   => esc_html__('Hide', 'elemenetskit'),
				'return_type' => 'yes',
		...
		$this->add_control(
            ...
            [
                'label' 		=> esc_html__('Enable Meeting Details?', 'elemenetskit'),
                'type' 			=> Controls_Manager::SWITCHER,
                'label_on' 		=> esc_html__('Show', 'elemenetskit'),
                'label_off' 	=> esc_html__('Hide', 'elemenetskit'),
				'return_type' 	=> 'yes',
		...
		$this->add_control(
            ...
            [
                'label' 		=> esc_html__('Show Meeting ID?', 'elemenetskit'),
                'type' 			=> Controls_Manager::SWITCHER,
                'label_on' 		=> esc_html__('Show', 'elemenetskit'),
                'label_off' 	=> esc_html__('Hide', 'elemenetskit'),
				'return_type' 	=> 'yes',
		...
		$this->add_control(
            ...
            [
                'label' 		=> esc_html__('Show Meeting Topic?', 'elemenetskit'),
                'type' 			=> Controls_Manager::SWITCHER,
                'label_on' 		=> esc_html__('Show', 'elemenetskit'),
                'label_off' 	=> esc_html__('Hide', 'elemenetskit'),
				'return_type' 	=> 'yes',
		...
		$this->add_control(
            ...
            [
                'label' 		=> esc_html__('Show Meeting Status?', 'elemenetskit'),
                'type' 			=> Controls_Manager::SWITCHER,
                'label_on' 		=> esc_html__('Show', 'elemenetskit'),
                'label_off' 	=> esc_html__('Hide', 'elemenetskit'),
				'return_type' 	=> 'yes',
		...
		$this->add_control(
            ...
            [
                'label' 		=> esc_html__('Show Meeting Start Time?', 'elemenetskit'),
                'type' 			=> Controls_Manager::SWITCHER,
                'label_on' 		=> esc_html__('Show', 'elemenetskit'),
                'label_off' 	=> esc_html__('Hide', 'elemenetskit'),
				'return_type' 	=> 'yes',
		...
		$this->add_control(
            ...
            [
                'label' 		=> esc_html__('Show Meeting Duration?', 'elemenetskit'),
                'type' 			=> Controls_Manager::SWITCHER,
                'label_on' 		=> esc_html__('Show', 'elemenetskit'),
                'label_off' 	=> esc_html__('Hide', 'elemenetskit'),
				'return_type' 	=> 'yes',
		...
		$this->add_control(
            ...
            [
                'label' 		=> esc_html__('Show Meeting Time Zone?', 'elemenetskit'),
                'type' 			=> Controls_Manager::SWITCHER,
                'label_on' 		=> esc_html__('Show', 'elemenetskit'),
                'label_off' 	=> esc_html__('Hide', 'elemenetskit'),
				'return_type' 	=> 'yes',
		...
		$this->add_control(
            ...
            [
                'label' 		=> esc_html__('Show Meeting Start Url?', 'elemenetskit'),
                'type' 			=> Controls_Manager::SWITCHER,
                'label_on' 		=> esc_html__('Show', 'elemenetskit'),
                'label_off' 	=> esc_html__('Hide', 'elemenetskit'),
				'return_type' 	=> 'yes',
		...
		$this->add_control(
            ...
            [
                'label' 		=> esc_html__('Show Meeting Join Url?', 'elemenetskit'),
                'type' 			=> Controls_Manager::SWITCHER,
                'label_on' 		=> esc_html__('Show', 'elemenetskit'),
                'label_off' 	=> esc_html__('Hide', 'elemenetskit'),
				'return_type' 	=> 'yes',
		...
		$this->add_control(
            'ekit_timer',
            [
                'label' => esc_html__( 'Timer:', 'elementskit-lite' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
		);
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Text Position', 'elementskit-lite' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'column',
                'options' => [
                    'column-reverse'  => esc_html__( 'Top', 'elementskit-lite' ),
                    'row' => esc_html__( 'Right', 'elementskit-lite' ),
                    'column' => esc_html__( 'Bottom', 'elementskit-lite' ),
                    'row-reverse' => esc_html__( 'Left', 'elementskit-lite' ),
				],
				'selectors'	=> [
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__( 'Password Input:', 'elementskit-lite' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
		);
	...
	protected function render_raw() {
		...
		$custom_settings = [
			'days' => $settings['ekit_zoom_timer_days_text'],
			'hours' => $settings['ekit_zoom_timer_hours_text'],
			'minutes' => $settings['ekit_zoom_timer_minutes_text'],
			'seconds' => $settings['ekit_zoom_timer_seconds_text']
		];
		// $non_loggedin = $settings['ekit_zoom_hide_links_non_loggedin'];

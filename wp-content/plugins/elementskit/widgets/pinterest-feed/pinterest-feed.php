...
class ElementsKit_Widget_Pinterest_Feed extends Widget_Base {
    ...
    private function control_section_profile_picture(){
        ...
        $this->add_responsive_control( 'profile_picture_size', [
            'label' => __( 'Picture Size', 'elementskit' ),
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __('johndoe', 'elementskit'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'home',
				'options' => [
					'home'  => __('Home Feed', 'elementskit'),
					'board' => __('Board Feed', 'elementskit'),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'       => __('Board name', 'elementskit'),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'placeholder' => __('Pinterest Board name', 'elementskit'),
                ...
                <div class="ekit-feed-items-wrapper ekit-feed-items-wrapper-pinterest">
                    ...
                    <div class="ekit-feed-pinterest-pins visible">
						...
						<?php if($ekit_feed_pins_card_style == 'masonry'): ?>
                            <div class='masonary ekit-fb-row ekit-layout-masonary <?php echo $column_count; ?>'>

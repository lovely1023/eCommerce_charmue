...
class ElementsKit_Widget_Woo_Product_List extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Last Child', 'elementskit-lite' ),
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Item Padding Last Child', 'elementskit-lite' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Item Margin Last Child', 'elementskit-lite' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'       => esc_html__( 'Item Border Last Child', 'elementskit-lite' ),
				'placeholder' => '1px',
				'default'     => '1px',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Search Field', 'elementskit-lite' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => [
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Select Field', 'elementskit-lite' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				'label'     => esc_html__( 'Arrow Size', 'elementskit-lite' ),
				'type'      => Controls_Manager::SLIDER,
				'selectors' => [
	...
	public function render_loop_item() {
		...
		if($wp_query->have_posts()) {
			...
			echo '<div class="attr-alert-warning attr-alert">' . esc_html__( 'Oops! No products were found.', 'elementskit-lite' ) .'</div>';
		}
	}

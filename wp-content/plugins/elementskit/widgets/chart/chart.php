	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'ekit_chart_data_section', [
				'label' => esc_html__('Data ', 'elementskit-lite'),
			]
		);
		...
		$chartRepeterCate->add_control(
			'ekit_chart_label', [
				...
				'default'     => esc_html__('January', 'elementskit-lite'),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					['ekit_chart_label' => esc_html__('January', 'elementskit-lite')],
					['ekit_chart_label' => esc_html__('February', 'elementskit-lite')],
					['ekit_chart_label' => esc_html__('March', 'elementskit-lite')],
		...
		$chartRepeter->add_control(
			'ekit_chart_data_label', [
				...
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__('Label #1', 'elementskit-lite'),
				'label_block' => true,
			]
		);
		$chartRepeter->add_control(
			'ekit_chart_data_set', [
				...
				'default'     => '10,23,15',
				'label_block' => true,
				'description' => esc_html__('Enter data values by "," separated(1). Example: 2,4,8,16,32 etc', 'elementskit-lite'),
			]
		);
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Set Data', 'elementskit-lite'),
				'type'    => Controls_Manager::REPEATER,
				'default' => [
					[
						'ekit_chart_data_label'            => esc_html__('Label #1', 'elementskit-lite'),
					...
					[
						'ekit_chart_data_label'            => esc_html__('Label #2', 'elementskit-lite'),
					...
					[
						'ekit_chart_data_label'            => esc_html__('Label #3', 'elementskit-lite'),
		...
		$this->add_control(
			'ekit_chart_style',
			[
				'label'   => esc_html__('Chart Styles', 'elementskit-lite'),
				'type'    => Controls_Manager::SELECT,
				'default' => 'bar',
				'options' => [
					'bar'           => esc_html__('Bar (Vertical)', 'elementskit-lite'),
					'horizontalBar' => esc_html__('Bar (Horozontal)', 'elementskit-lite'),
					'line'          => esc_html__('Line', 'elementskit-lite'),
					'radar'         => esc_html__('Radar', 'elementskit-lite'),
					'doughnut'      => esc_html__('Doughnut', 'elementskit-lite'),
					'pie'           => esc_html__('Pie', 'elementskit-lite'),
					'polarArea'     => esc_html__('Polar Area', 'elementskit-lite'),
				],
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Grid Lines', 'elementskit-lite'),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'condition' => ['ekit_chart_style!' => ['doughnut', 'pie', 'polarArea']],
			]
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Grid Color', 'elementskit-lite'),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Enable Label', 'elementskit-lite'),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'separetor' => 'before',
			]
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Enable Legends', 'elementskit-lite'),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Show Tooltip', 'elementskit-lite'),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
				'separetor' => 'before',
			]
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Point Style', 'elementskit-lite'),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'circle',
				'options'   => [
					'circle'   => 'Circle',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Stepped Line', 'elementskit-lite'),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => 'yes',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Tension', 'elementskit-lite'),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 0.4,
				'min'       => 0,
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Fill', 'elementskit-lite'),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'bottom',
				'options'   => [
					'top'    => 'Top',
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Font Color', 'elementskit-lite'),
				'type'    => Controls_Manager::COLOR,
				'default' => '#666',
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Font Style', 'elementskit-lite'),
				'type'    => Controls_Manager::SELECT,
				'default' => 'normal',
				'options' => [
					'bold'   => 'Bold',
		...
		$this->start_controls_section(
			'ekit_chart_section_style_legend', [
				'label'     => esc_html__('Legend', 'elementskit-lite'),
				'tab'       => Controls_Manager::TAB_STYLE,
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__('Box Width', 'elementskit-lite'),
				'type'      => Controls_Manager::NUMBER,
				'min'       => 0,
				'max'       => 300,
				'step'      => 1,
		...
		$this->start_controls_section(
			'ekit_chart_section_style_tooltip', [
				'label'     => esc_html__('Tooltip', 'elementskit-lite'),
				'tab'       => Controls_Manager::TAB_STYLE,
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Title Font Color', 'elementskit-lite'),
				'type'    => Controls_Manager::COLOR,
				'default' => '#fff',
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Title Font Size', 'elementskit-lite'),
				'type'    => Controls_Manager::NUMBER,
				'min'     => 0,
				'max'     => 100,
				'step'    => 1,
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Title Font Style', 'elementskit-lite'),
				'type'    => Controls_Manager::SELECT,
				'default' => 'normal',
				'options' => [
					'bold'   => 'Bold',
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Body Font Color', 'elementskit-lite'),
				'type'    => Controls_Manager::COLOR,
				'default' => '#fff',
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Body Font Size', 'elementskit-lite'),
				'type'    => Controls_Manager::NUMBER,
				'min'     => 0,
				'max'     => 100,
				'step'    => 1,
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Body Font Style', 'elementskit-lite'),
				'type'    => Controls_Manager::SELECT,
				'default' => 'normal',
				'options' => [
					'bold'   => 'Bold',

...
class ElementsKit_Widget_Video_Gallery extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $repeater->add_control(
            'video_image',
            [
                'label' => esc_html__( 'Custom Image', 'elementskit-lite' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'carousel' => esc_html__( 'Carousel', 'elementskit-lite' ),
                ],
            ]
        );
		...
		$this->add_control(
            'click_action',
            [
                'label' =>esc_html__( 'Click Action', 'elementskit-lite' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'popup',
                'options' => [
                    'popup' =>esc_html__( 'Play In Popup', 'elementskit-lite' ),
                    'inline' =>esc_html__( 'Play Inline', 'elementskit-lite' )
                ],
            ]
		);
         ...
         $this->add_control(
			'enable_filter',
			[
				'label' => esc_html__( 'Show Filter?', 'elementskit-lite' ),
        ...
        $this->add_control(
			'play_btn',
			[
				'label' => esc_html__( 'Play button on hover?', 'elementskit-lite' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'elementskit-lite' ),
				'label_off' => esc_html__( 'Hide', 'elementskit-lite' ),
				'return_value' => 'yes',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Video Icon', 'elementskit-lite' ),
                'tab' => Controls_Manager::TAB_STYLE
            ]
        );

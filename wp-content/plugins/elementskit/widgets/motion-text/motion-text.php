...
class ElementsKit_Widget_Motion_Text extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Enable Animation', 'elementskit-lite' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Motion Animation', 'elementskit-lite' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'none' => 'None',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Spilit Text Animation', 'elementskit-lite' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'no_spilit',
				'options' => [
					'no_spilit'  => esc_html__( 'No Spilit', 'elementskit-lite' ),
					'char_based' => esc_html__( 'Letter Based', 'elementskit-lite' ),
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Animation Duration By Charecter (in s)', 'elementskit-lite' ),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Animation Delay By Charecter (in ms)', 'elementskit-lite' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 1,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Animation Duration (in s)', 'elementskit-lite' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 1,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Animation Duration Reveal (in s)', 'elementskit-lite' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 1,

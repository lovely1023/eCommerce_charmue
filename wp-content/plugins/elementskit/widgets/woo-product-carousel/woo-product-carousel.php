...
class ElementsKit_Widget_Woo_Product_Carousel extends Widget_Base {
    ...
    public function elementskit_navigation_position() {
		$position_options = [
			'top-left'      => esc_html__('Top Left', 'elementskit-lite') ,
			'top-center'    => esc_html__('Top Center', 'elementskit-lite') ,
			'top-right'     => esc_html__('Top Right', 'elementskit-lite') ,
			'center'        => esc_html__('Center', 'elementskit-lite') ,
			'bottom-left'   => esc_html__('Bottom Left', 'elementskit-lite') ,
			'bottom-center' => esc_html__('Bottom Center', 'elementskit-lite') ,
			'bottom-right'  => esc_html__('Bottom Right', 'elementskit-lite') ,
		];
    ...
    function elementskit_transition_options() {
        $transition_options = [
            ...
            'scale-up'            => esc_html__('Scale Up', 'elementskit-lite'),
            'scale-down'          => esc_html__('Scale Down', 'elementskit-lite'),
            'slide-top'           => esc_html__('Slide Top', 'elementskit-lite'),
            'slide-bottom'        => esc_html__('Slide Bottom', 'elementskit-lite'),
            'slide-left'          => esc_html__('Slide Left', 'elementskit-lite'),
            'slide-right'         => esc_html__('Slide Right', 'elementskit-lite'),
            'slide-top-small'     => esc_html__('Slide Top Small', 'elementskit-lite'),
            'slide-bottom-small'  => esc_html__('Slide Bottom Small', 'elementskit-lite'),
            'slide-left-small'    => esc_html__('Slide Left Small', 'elementskit-lite'),
            'slide-right-small'   => esc_html__('Slide Right Small', 'elementskit-lite'),
            'slide-top-medium'    => esc_html__('Slide Top Medium', 'elementskit-lite'),
            'slide-bottom-medium' => esc_html__('Slide Bottom Medium', 'elementskit-lite'),
            'slide-left-medium'   => esc_html__('Slide Left Medium', 'elementskit-lite'),
            'slide-right-medium'  => esc_html__('Slide Right Medium', 'elementskit-lite'),
        ];
    ...
    public function _register_controls() {
        ...
        $this->add_control(
			...
			[
				'label'   => esc_html__( 'Show product by ', 'elementskit-lite' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'category',
				'options' => [
                    'category' => esc_html__('Category', 'elementskit-lite'),
                    'product' => esc_html__('Product', 'elementskit-lite'),
                ],
			]
        );
		...
		$this->add_control(
			'ekit_woo_cat',
			[
				'label'   => esc_html__( 'Category', 'elementskit-lite' ),
		...
		$this->add_control(
			'ekit_woo_product',
			[
				'label'   => esc_html__( 'Product', 'elementskit-lite' ),
				'type'    => ElementsKit_Controls_Manager::AJAXSELECT2,
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'category' => esc_html__( 'Category', 'elementskit-lite' ),
					'rand'     => esc_html__( 'Random', 'elementskit-lite' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'DESC',
				'options' => [
					'DESC' => esc_html__( 'Descending', 'elementskit-lite' ),
					'ASC'  => esc_html__( 'Ascending', 'elementskit-lite' ),
				],
			]
		);
		...
		$this->add_control(
            ...
            [
                'label' => esc_html__('Flip Content? ', 'elementskit-lite'),
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__( 'Content Postion', 'elementskit-lite' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'outside',
				'options' => [
		...
		$this->add_control(
			...
			[
				'label'          => esc_html__( 'Desktop Columns', 'elementskit-lite' ),
				'type'           => Controls_Manager::SELECT,
				'default'        => '4',
				'options'        => [
					'1' => '1',
		...
		$this->add_control(
			'ekit_columns_tablet',
			[
				'label'          => esc_html__( 'Tablet Columns', 'elementskit-lite' ),
				'type'           => Controls_Manager::SELECT,
				'default' => '3',
				'options'        => [
					'1' => '1',
		...
		$this->add_control(
			'ekit_columns_mobile',
			[
				'label'          => esc_html__( 'Mobile Columns', 'elementskit-lite' ),
				'type'           => Controls_Manager::SELECT,
				'default' => '1',
				'options'        => [
					'1' => '1',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Open Thumb in Popup', 'elementskit-lite' ),
				'type'      => Controls_Manager::SWITCHER,
			]
		);
		...
		$this->add_control(
			'ekit_show_cart',
			[
				'label'   => esc_html__( 'Add to Cart', 'elementskit-lite' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Carousel Settings', 'elementskit-lite' ),
			]
		);
		...
		$this->add_control(
			'ekit_autoplay_speed',
			[
				'label'     => esc_html__( 'Autoplay Speed', 'elementskit-lite' ),
				'type'      => Controls_Manager::NUMBER,
				'default'   => 5000,
				'condition' => [
					'ekit_autoplay' => 'yes',
		...
		$this->add_control(
			'ekit_speed',
			[
				'label'   => esc_html__( 'Animation Speed', 'elementskit-lite' ),
				'type'    => Controls_Manager::SLIDER,
				'default' => [
					'size' => 50,
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => 'none',
				'options' => [
					'both'   => esc_html__( 'Arrows and Dots', 'elementskit-lite' ),
					'arrows' => esc_html__( 'Arrows', 'elementskit-lite' ),
					'dots'   => esc_html__( 'Dots', 'elementskit-lite' ),
		...
		$this->add_control(
			'ekit_both_position',
			[
				'label'     => esc_html__( 'Arrows and Dots Position', 'elementskit-lite' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'center',
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Arrows Position', 'elementskit-lite' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'center',
				'options'   => $this->elementskit_navigation_position(),
				'condition' => [
		...
		$this->add_control(
			'ekit_dots_position',
			[
				'label'     => esc_html__( 'Dots Position', 'elementskit-lite' ),
				'type'      => Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			'ekit_desc_padding',
			[
				'label'      => esc_html__( 'Description Padding', 'elementskit-lite' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Sale Price', 'elementskit-lite' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'ekit_show_price' => 'yes',
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Image Border', 'elementskit-lite' ),
				'selector' => '{{WRAPPER}} .ekit-wc-products .ekit-wc-product-image',
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Fullwidth Button', 'elementskit-lite' ),
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Fullwidth Badge', 'elementskit-lite' ),
				'type'      => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label'     => esc_html__( 'Add to Cart Button', 'elementskit-lite' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_cart' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Overlay Animation', 'elementskit-lite' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'fade',
		...
		$this->add_control(
			'ekit_arrows_size',
			[
				'label' => esc_html__( 'Arrows Size', 'elementskit-lite' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 20,
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Hover Background Color', 'elementskit-lite' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'ekit_arrows_space',
			[
				'label' => esc_html__( 'Space', 'elementskit-lite' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'ekit_arrows_color',
			[
				'label'     => esc_html__( 'Arrows Color', 'elementskit-lite' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Arrows Hover Color', 'elementskit-lite' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'ekit_dots_size',
			[
				'label' => esc_html__( 'Dots Size', 'elementskit-lite' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 5,
		...
		$this->add_control(
			'ekit_dots_space',
			[
				'label' => esc_html__( 'Dots Space', 'elementskit-lite' ),
				'type'  => Controls_Manager::SLIDER,
				'default' => [
					'size' => 5,
				],
		...
		$this->start_controls_tabs('ekit_dots_color_tabs');
			...
			$this->add_control(
				'ekit_dots_color',
				[
					'label'     => esc_html__( 'Dots Color', 'elementskit-lite' ),
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				...
				[
					'label'     => esc_html__( 'Active Dots Color', 'elementskit-lite' ),
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'View Cart Button', 'elementskit-lite' ),
	...
	public function render_loop_item() {
		...
		if($wp_query->have_posts()) {
			...
			echo '<div class="attr-alert attr-alert-warning">'. esc_html__( 'Oppps!! There is no product', 'elementskit-lite' ) .'</div>';
		}
	}

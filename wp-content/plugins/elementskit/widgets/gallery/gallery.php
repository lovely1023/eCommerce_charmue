...
class ElementsKit_Widget_Gallery extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Gallery Content', 'elementskit-lite' ),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Filter Label', 'elementskit-lite' ),
        ...
        $repeater->add_control(
            ...
            [
                'label' => esc_html__( 'Add Images', 'elementskit-lite' ),
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Image Aspect Ratio', 'elementskit-lite' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( '"All" Filter Label', 'elementskit-lite' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'All', 'elementskit-lite' ),
            ]
        );
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Filter Label', 'elementskit-lite' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'elementskit-lite' ),
				'label_off' => esc_html__( 'Hide', 'elementskit-lite' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Lightbox', 'elementskit-lite' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'elementskit-lite' ),
				'label_off' => esc_html__( 'Hide', 'elementskit-lite' ),
				'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Lightbox Icon', 'elementskit-lite' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Image Slideshow', 'elementskit-lite' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'True', 'elementskit-lite' ),
				'label_off' => esc_html__( 'Flase', 'elementskit-lite' ),
				'return_value' => 'yes',
                'default' => 'yes',
                'condition' => [
                    'ekit_gallery_open_lightbox' => 'yes'
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Ordering', 'elementskit-lite' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => esc_html__( 'Default', 'elementskit-lite' ),
                    'random' => esc_html__( 'Random', 'elementskit-lite' ),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Columns Gap', 'elementskit-lite' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 5,
                    'unit' => 'px',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Thumbnails', 'elementskit-lite' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $ekit_image_filters = [
            ...
            'opacity' => esc_html__( 'Opacity', 'elementskit-lite' ),
            'scale' => esc_html__( 'Scale', 'elementskit-lite' ),
            'rotate' => esc_html__( 'Rotate', 'elementskit-lite' ),
            'blur' => esc_html__( 'Blur', 'elementskit-lite' ),
            'gray-scale' => esc_html__( 'Gray Scale', 'elementskit-lite' ),
        ];

        $this->add_control(
            'ekit_gallery_thumbnail_filter',
            [
                'label' => esc_html__( 'Image Filter', 'elementskit-lite' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'normal',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Blur', 'elementskit-lite' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
					'px' => [
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Gray Scale', 'elementskit-lite' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%' ],
				'range' => [
					'%' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Tilt', 'elementskit-lite' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Axis', 'elementskit-lite' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'both',
                'options' => [
                    'both' => esc_html__( 'Both', 'elementskit-lite' ),
                    'x' => esc_html__( 'X Axis', 'elementskit-lite' ),
                    'y' => esc_html__( 'Y Axis', 'elementskit-lite' ),
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Amount', 'elementskit-lite' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Depth', 'elementskit-lite' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Glare', 'elementskit-lite' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'elementskit-lite' ),
				'label_off' => esc_html__( 'Hide', 'elementskit-lite' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Perspective', 'elementskit-lite' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Caption', 'elementskit-lite' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Link Icon', 'elementskit-lite' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'ekit_gallery_open_lightbox' => 'yes',
                ]
        ...
        $ekit_image_blend_mode = [
            ...
            'color-burn' => esc_html__( 'Color-burn', 'elementskit-lite' ),
            'difference' => esc_html__( 'Difference', 'elementskit-lite' ),
            'exclusion' => esc_html__( 'Exclusion', 'elementskit-lite' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Filter Style', 'elementskit-lite' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => [
					'default'  => esc_html__( 'Default', 'elementskit-lite' ),
					'style_one' => esc_html__( 'Style One', 'elementskit-lite' ),
					'style_two' => esc_html__( 'Style Two', 'elementskit-lite' ),
					'style_three' => esc_html__( 'Style Three', 'elementskit-lite' ),
					'style_four' => esc_html__( 'Style Four', 'elementskit-lite' ),
					'style_five' => esc_html__( 'Style Five', 'elementskit-lite' ),
					'style_six' => esc_html__( 'Style Six', 'elementskit-lite' ),
					'style_seven' => esc_html__( 'Style Seven', 'elementskit-lite' ),
					'style_eight' => esc_html__( 'Style Eight', 'elementskit-lite' ),
					'style_nine' => esc_html__( 'Style Nine', 'elementskit-lite' ),
					'style_ten' => esc_html__( 'Style Ten', 'elementskit-lite' ),
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Nav Fill', 'elementskit-lite' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Yes', 'elementskit-lite' ),
				'label_off' => esc_html__( 'No', 'elementskit-lite' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                'label'    => esc_html__( 'Filter Items Alignment', 'elementskit-lite' ),
                'type'     => Controls_Manager::CHOOSE,
                'options'  => [
                    'flex-start'   => [
                        'title' => esc_html__( 'Left', 'elementskit-lite' ),
        ...
        $this->add_control(
            ...
            [
                'label'    => esc_html__( 'Filter Alignment', 'elementskit-lite' ),
                'type'     => Controls_Manager::CHOOSE,
                'options'  => [
                    'left'   => [
                        'title' => esc_html__( 'Left', 'elementskit-lite' ),
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Show Divider', 'elementskit-lite' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'Show', 'elementskit-lite' ),
				'label_off' => esc_html__( 'Hide', 'elementskit-lite' ),
				'return_value' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Nav Bottom Spacing', 'elementskit-lite' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
    ...
    ?>
        ...
        <?php if(count($ekit_gallery_items) > 0): foreach($ekit_gallery_items as $item): // ekit_gallery_items // ekit_gallery_filter_images
            ...
            foreach( $item['ekit_gallery_filter_images'] as $img ):
                ...
                ?>
                <?php
                    // if(isset($ekit_gallery_enable_link) && $ekit_gallery_enable_link === 'yes') :

                    // if ( ! empty( $settings['ekit_gallery_web_link']['url'] ) ) {
                    //     $this->add_link_attributes( 'button', $settings['ekit_gallery_web_link'] );
                    // }
                ?>
                <?php // <!-- <a echo $this->get_render_attribute_string( 'button' );> --> ?>
                <?php // endif; ?>

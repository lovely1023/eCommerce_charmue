...
class ElementsKit_Widget_Facebook_Feed extends Widget_Base {
	...
	protected function render_raw() {
		...
		if(!empty($page['param']['pg_id'])):
			...
			if(!empty($load['success'])) {
				...
				$show_reaction = $show_reaction === 'yes' ? true : false;
                                ...
                                <div class="ekit-single-fb-feed-holder <?php echo esc_attr($columnFeed); ?>">
									<div 
										class="facebook-feed-card ekit-single-fb-feed<?php 
											echo in_array($per_post_image_position, ['left', 'background']) ? ' image-in-' . $image_position : ''; 
											echo $image_bg_style == 's2' ? ' bg-img-style-2' : ''
										?>"
									...
									>
                                            ...
                                            <div class="ekit-fb-feed-header">
                                                <div class="ekit-fb-feed-profile-thumb">
													...
													if(in_array($ekit_facebook_feed_author_type, [ 'both', 'only-profile' ])): ?>
                                                        <a 
                                                           	target="_blank"
															href="https://www.facebook.com/<?php echo esc_html($userName); ?>"
                                                           	class="<?php echo esc_attr($ekit_facebook_feed_author_style); echo $show_thumbnail_outline ? ' has-outline' : '' ?>">
                                                            	<img 
                                                ...
                                                <div class="ekit-fb-feed-profile-info">
													...
													if($ekit_facebook_feed_show_post_date == 'yes'): ?>
                                                        <span class="ekit-fb-post-publish-date">
															<?php echo esc_attr($pic_created_time); ?>
														</span>
														<?php
													endif; ?>
                                        ...
                                        <!--End Body -->
											...
											<?php if($show_reaction): ?>
												<div class="ekit-fb-fotter-section<?php echo $reaction_style == 's2' ? ' style-02' : '' ?>">
													<?php if($reaction_style == 's1'): ?>
														<div class="ekit-fb-reaction-left">
															...
															>
																...
																<strong class='count'> <?php echo $convert_reaction ?> </strong>
															</a>
														</div>
														<div>
											...
											<?php if($per_post_show_share_and_view): ?>
												...
												<div class='ekit-fb-feed-share'>
													...
													<a href="<?php echo $fbjson->permalink_url ;?>"  class='ekit-fb-feed-share__view' target="_blank">
														<span class='medium-text'>View</span>
	...
	protected function render_icon($settings, $control_key, $classes ) {
		...
		if ( $is_new || $migrated ) :
			...
			<i class="<?php echo $classes .' '. $settings[$control_key]; ?>" aria-hidden="true"></i>
		<?php endif;
	}
			...
			<?php if(!empty($fbjson->attachments->data)):
				...
				foreach( $objs as $obj ):
					if($obj->type == 'photo' || $obj->type == 'album') : ?>
						<img src="<?php echo $obj->media->image->src; ?>" alt="Post Image"/>
					<?php elseif( 
						$obj->type == 'share' || 
						...
						<img 
							src="<?php echo $obj->media->image->src; ?>"
							title="<?php echo $obj->title ?>"
							alt="<?php echo $obj->title ?>" 
						/>
					<?php elseif(
					...
					$fb_full_picture  = isset($fbjson->full_picture) ? $fbjson->full_picture : '';
					?>
						<div class='video-container' data-src="<?php echo $obj->media->source; ?>">
							...
							<div class="ekit-fb-hover-content">
								<div class="ekit-fb-video-play-button">
									<svg xmlns="http://www.w3.org/2000/svg" style="display: initial;" viewBox="0 0 512 512">

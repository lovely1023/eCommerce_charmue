...
class ElementsKit_Widget_Unfold extends Widget_Base {
    ...
    protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				'label'   => esc_html__('Enable Template', 'elementskit-lite'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Expand Button Text', 'elementskit-lite' ),
				'type' => Controls_Manager::TEXT,
				'default'	=> 'Read More'
			]
		);
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Collapse Button Text', 'elementskit-lite' ),
				'type' => Controls_Manager::TEXT,
				'default'	=> 'Read Less'
			]
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Content Options', 'elementskit-lite' ),
			)
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Content Expand Direction', 'elemenetskit'),
				'type' => Controls_Manager::SELECT,
				'default' => 'above',
				'options' => [
					'above' => esc_html__('Above Button', 'elemenetskit'),
					'below' => esc_html__('Below Button', 'elemenetskit'),
				],
			]
		);
		...
		$this->add_responsive_control(
			'unfold_collapsed_content_height', [
				'label'			 =>esc_html__( 'Collapsed Content Height', 'elementskit-lite' ),
		...
		$this->add_control(
            ...
            [
                'label'     => esc_html__( 'Transition Duration', 'elementskit-lite' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' =>esc_html__( 'Button Alignment', 'elementskit-lite' ),
		...
		$this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Paragraph Spacing', 'elementskit-lite' ),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range' => [
                    'px' => [
				...
				<div class="ekit-unfold-data">
					<div class="ekit-unfold-data-inner">
						<?php if(!empty($unfold_enable_template) && $unfold_enable_template == 'yes') {
							...
							echo '<div class="ekit-unfold-raw-content">'. do_shortcode(($unfold_content)) .'</div>';
						} ?>
					</div>
				</div>

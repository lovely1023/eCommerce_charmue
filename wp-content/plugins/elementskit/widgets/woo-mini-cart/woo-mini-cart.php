...
class ElementsKit_Widget_Woo_Mini_Cart extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Cart Visibility', 'elementskit-lite' ),
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Cart Button', 'elementskit-lite' ),
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Quantity:', 'elementskit-lite' ),
                'type' => Controls_Manager::HEADING,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Remove:', 'elementskit-lite' ),
                'type' => Controls_Manager::HEADING,
            ]
        );
        ...
        $this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Subtotal', 'elementskit-lite' ),
				'tab' => \Elementor\Controls_Manager::TAB_STYLE,
			]
        );
            ...
            <div class="ekit-dropdown-back ekit-mini-cart-visibility-<?php echo esc_attr( $settings['ekit_woo_mini_cart_visibility'] ); ?>" data-toggle="mini-cart-dropdown">
                ...
                <div class="ekit-mini-cart-container">
                    <div class="mini-cart-header">
                        <ul>
                            <li><span class="ekit-cart-count"><?php echo (( WC()->cart != '' ) )?  WC()->cart->get_cart_contents_count() : '' ; ?></span> <?php esc_html_e( 'items', 'elementskit-lite' ); ?></li>
                            <li><a href="<?php echo esc_url( wc_get_cart_url() ); ?>"><?php esc_html_e( 'view cart', 'elementskit-lite' ); ?></a></li>
                        </ul>
                    </div>

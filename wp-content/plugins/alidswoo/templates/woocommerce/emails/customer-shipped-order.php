...
<?php /* translators: %s: Order number */ ?>
    <p><?php printf( esc_html__( 'Your recent order %s has been shipped. Your order details are shown below for your reference:', 'adsw' ), esc_html( $order->get_order_number() ) ); ?></p>

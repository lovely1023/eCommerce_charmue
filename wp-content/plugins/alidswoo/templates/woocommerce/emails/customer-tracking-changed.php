...
<?php /* translators: %s: Order number */ ?>
    <p><?php printf( esc_html__( 'Please be informed that your order Tracking ID has been changed for the following product(s):', 'adsw' ), esc_html( $order->get_order_number() ) ); ?></p>

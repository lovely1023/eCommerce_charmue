...
if ( isset( $GLOBALS['svx'] ) && version_compare( $GLOBALS['svx'], '1.5.0' ) == 0 ) :
	...
	class SevenVXSettings {
		...
		public function add_templates() {
			...
			<script type="text/template" id="tmpl-svx-license">
				<div class="svx-license">
					<h2><?php esc_html_e( 'Plugin not registered!', 'xforwoocommerce' ); ?></h2>
					<p>
						{{ data.name }} <?php esc_html_e( 'license is not registered. Please register! Click Register now button to start.', 'xforwoocommerce' ); ?><br />
						<?php esc_html_e( 'Need help? Visit this link', 'xforwoocommerce' ); ?> &rarr; <a href="https://help.xforwoocommerce.com/how-to-register" target="_blank"><?php esc_html_e( 'How to register?', 'xforwoocommerce' ); ?></a>
					</p>
					<span id="svx-register" class="svx-button"><?php esc_html_e( 'Register now', 'xforwoocommerce' ); ?></span>
				</div>
			</script>
			...
			<script type="text/template" id="tmpl-svx-license-input">
				...
				<span id="svx-register-confirm" class="svx-button svx-button-primary"><?php esc_html_e( 'Confirm key', 'xforwoocommerce' ); ?></span>
				<a href="https://help.xforwoocommerce.com/my-support-tickets/" id="svx-register-get-key" class="svx-button" target="_blank"><?php esc_html_e( 'Get key', 'xforwoocommerce' ); ?></span>
			</script>

...
global $tab_style;
$tab_style = get_theme_mod( 'sparklestore_pro_woo_product_tab_style' );
if ($tab_style == 'sections') {
	wc_get_template_part( 'single-product/tabs/sections' );
	return;
}

// Get accordion instead of tabs if set.
if ( $tab_style == 'accordian'  || $tab_style == 'toggle'  ) {
	wc_get_template_part( 'single-product/tabs/accordian' );
	return;
}
...
if ( ! empty( $product_tabs ) ) : ?>
	...
	<div class="woocommerce-tabs wc-tabs-wrapper tabbed-content <?php sparklestore_pro_product_tabs_classes(); ?>">

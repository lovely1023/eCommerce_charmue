...
if( is_singular() ){
	$post_sidebar =  esc_attr( get_theme_mod( 'sparklestore_pro_woocommerce_single_products_page_layout','rightsidebar' ) );
}else{
	$post_sidebar =  esc_attr( get_theme_mod( 'sparklestore_pro_woocommerce_products_page_layout','rightsidebar' ) );
}

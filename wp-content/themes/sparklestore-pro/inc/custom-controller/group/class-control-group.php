...
if ( class_exists( 'WP_Customize_Control' ) && ! class_exists( 'SparkleWP_Custom_Control_Group' ) ) :
	 ...
	 *
	 */
	class SparkleWP_Custom_Control_Group extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_style('sparklewp-group-control', SPARKLESTORE_PRO_URL . '/inc/custom-controller/group/css/group.css', array(), SPARKLESTORE_PRO_VERSION);
			wp_enqueue_script('sparklewp-group-control', SPARKLESTORE_PRO_URL.'/inc/custom-controller/group/js/group.js', array( 'jquery', 'customize-controls' ), SPARKLESTORE_PRO_VERSION, true);

			wp_localize_script(
				'sparklewp-group-control',
				'sparklewpLocalize',
				array(
					'colorPalettes' => sparklewp_default_color_palettes(),
				)
			);
		}
				...
				<div class="group-fields hidden">
							...
							switch ( $field['type'] ) {
								...
								case 'image':
									...
									<span class="img-preview-wrap" <?php echo  $sparklewp_display_none; ?>>
											<img class="widefat" src="<?php echo esc_url( $new_value ); ?>" alt="<?php esc_attr_e( 'Image preview', 'sparklewp' ); ?>"  />
									</span><!-- .img-preview-wrap -->
									<input type="button" value="<?php esc_attr_e( 'Upload Image', 'sparklewp' ); ?>" class="button sparklewp-image-upload" data-title="<?php esc_attr_e( 'Select Image', 'sparklewp' ); ?>" data-button="<?php esc_attr_e( 'Select Image', 'sparklewp' ); ?>"/>
									<input type="button" value="<?php esc_attr_e( 'Remove Image', 'sparklewp' ); ?>" class="button sparklewp-image-remove" />
					...
					<div class="clearfix group-footer">
						<a class="group-field-close" href="#close">
							<?php esc_html_e( 'Close', 'sparklewp' ); ?>
						</a>
					</div>
				</div>
			</li>
		...
		public function css_box( $values = array(), $key, $cssbox_fields ) {
			...
			$link_text   = isset( $attr['link_text'] ) ? $attr['link_text'] : esc_html__( 'Link', 'sparklewp' );

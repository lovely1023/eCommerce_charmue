<?php
/**
 * Customizer Control: sparklewp-cssbox.
 *
...
if( class_exists('WP_Customize_Control')){
	 ...
	 * Buttonset control
	 */
	class SparkleWP_Custom_Control_Cssbox extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_style('sparklewp-cssbox', SPARKLESTORE_PRO_URL . '/inc/custom-controller/cssbox/css/cssbox.css', array(), SPARKLESTORE_PRO_VERSION);
			wp_enqueue_script('sparklewp-cssbox', SPARKLESTORE_PRO_URL.'/inc/custom-controller/cssbox/js/cssbox.js', array( 'jquery', 'customize-controls' ), SPARKLESTORE_PRO_VERSION, true);
		}

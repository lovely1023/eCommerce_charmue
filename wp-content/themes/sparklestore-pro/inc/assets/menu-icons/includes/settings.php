...
final class Menu_Icons_Settings {
	...
	public static function _admin_notices() {
		$messages = array(
			'updated' => __( '<strong>Menu Icons Settings</strong> have been successfully updated.', 'sparklestore-pro' ),
			'reset'   => __( '<strong>Menu Icons Settings</strong> have been successfully reset.', 'sparklestore-pro' ),
		);
	...
	private static function _add_settings_meta_box() {
		add_meta_box(
			'menu-icons-settings',
			__( 'Menu Icons Settings', 'sparklestore-pro' ),
	...
	public static function get_settings_fields( array $values = array() ) {
		$fields = array(
			'hide_label' => array(
				'id'      => 'hide_label',
				'type'    => 'select',
				'label'   => __( 'Hide Label', 'sparklestore-pro' ),
				'default' => '',
				'choices' => array(
					array(
						'value' => '',
						'label' => __( 'No', 'sparklestore-pro' ),
					),
					array(
						'value' => '1',
						'label' => __( 'Yes', 'sparklestore-pro' ),
					),
				),
			),
			'position' => array(
				'id'      => 'position',
				'type'    => 'select',
				'label'   => __( 'Position', 'sparklestore-pro' ),
				'default' => 'before',
				'choices' => array(
					array(
						'value' => 'before',
						'label' => __( 'Before', 'sparklestore-pro' ),
					),
					array(
						'value' => 'after',
						'label' => __( 'After', 'sparklestore-pro' ),
					),
				),
			),
			'vertical_align' => array(
				'id'      => 'vertical_align',
				'type'    => 'select',
				'label'   => __( 'Vertical Align', 'sparklestore-pro' ),
				'default' => 'middle',
				'choices' => array(
					array(
						'value' => 'super',
						'label' => __( 'Super', 'sparklestore-pro' ),
					),
					array(
						'value' => 'top',
						'label' => __( 'Top', 'sparklestore-pro' ),
					),
					array(
						'value' => 'text-top',
						'label' => __( 'Text Top', 'sparklestore-pro' ),
					),
					array(
						'value' => 'middle',
						'label' => __( 'Middle', 'sparklestore-pro' ),
					),
					array(
						'value' => 'baseline',
						'label' => __( 'Baseline', 'sparklestore-pro' ),
					),
					array(
						'value' => 'text-bottom',
						'label' => __( 'Text Bottom', 'sparklestore-pro' ),
					),
					array(
						'value' => 'bottom',
						'label' => __( 'Bottom', 'sparklestore-pro' ),
					),
					array(
						'value' => 'sub',
						'label' => __( 'Sub', 'sparklestore-pro' ),
					),
				),
			),
			'font_size' => array(
				'id'          => 'font_size',
				'type'        => 'number',
				'label'       => __( 'Font Size', 'sparklestore-pro' ),
				'default'     => '1.2',
				'description' => 'em',
				'attributes'  => array(
					'min'  => '0.1',
			...
			'svg_width' => array(
				'id'          => 'svg_width',
				'type'        => 'number',
				'label'       => __( 'SVG Width', 'sparklestore-pro' ),
				'default'     => '1',
				'description' => 'em',
				'attributes'  => array(
					'min'  => '.5',
			...
			'image_size' => array(
				'id'      => 'image_size',
				'type'    => 'select',
				'label'   => __( 'Image Size', 'sparklestore-pro' ),
				'default' => 'thumbnail',
	...
	public static function get_fields() {
		...
		$sections = array(
			'global' => array(
				'id'          => 'global',
				'title'       => __( 'Global', 'sparklestore-pro' ),
				'description' => __( 'Global settings', 'sparklestore-pro' ),
				'fields'      => array(
					array(
						'id'      => 'icon_types',
						'type'    => 'checkbox',
						'label'   => __( 'Icon Types', 'sparklestore-pro' ),
						'choices' => $icon_types,
		...
		if ( ! empty( $menu_id ) ) {
			...
			$sections['menu'] = array(
				'id'          => $menu_key,
				'title'       => __( 'Current Menu', 'sparklestore-pro' ),
				'description' => sprintf(
					__( '"%s" menu settings', 'sparklestore-pro' ),
		...
		?>
			...
			<p class="submitbox button-controls">
				...
				<span class="list-controls">
					<?php
						printf(
							...
							esc_attr__( 'Discard all changes and reset to default state', 'sparklestore-pro' ),
							esc_html__( 'Reset', 'sparklestore-pro' )
						);
					?>
				</span>
				...
				<span class="add-to-menu">
					...
					<?php
						submit_button(
							__( 'Save Settings', 'sparklestore-pro' ),
							'secondary',
	...
	public static function _enqueue_assets() {
		...
		$js_data = apply_filters(
			...
			array(
				'text'           => array(
					'title'        => __( 'Select Icon', 'sparklestore-pro' ),
					'select'       => __( 'Select', 'sparklestore-pro' ),
					'remove'       => __( 'Remove', 'sparklestore-pro' ),
					'change'       => __( 'Change', 'sparklestore-pro' ),
					'all'          => __( 'All', 'sparklestore-pro' ),
					'preview'      => __( 'Preview', 'sparklestore-pro' ),
					'settingsInfo' => '',
				),

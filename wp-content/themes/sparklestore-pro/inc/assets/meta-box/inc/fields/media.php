...
class RWMB_Media_Field extends RWMB_File_Field {
	...
	public static function admin_enqueue_scripts() {
		...
		RWMB_Helpers_Field::localize_script_once(
			...
			'i18nRwmbMedia',
			array(
				'add'                => apply_filters( 'rwmb_media_add_string', _x( '+ Add Media', 'media', 'sparklestore-pro' ) ),
				'single'             => apply_filters( 'rwmb_media_single_files_string', _x( ' file', 'media', 'sparklestore-pro' ) ),
				'multiple'           => apply_filters( 'rwmb_media_multiple_files_string', _x( ' files', 'media', 'sparklestore-pro' ) ),
				'remove'             => apply_filters( 'rwmb_media_remove_string', _x( 'Remove', 'media', 'sparklestore-pro' ) ),
				'edit'               => apply_filters( 'rwmb_media_edit_string', _x( 'Edit', 'media', 'sparklestore-pro' ) ),
				'view'               => apply_filters( 'rwmb_media_view_string', _x( 'View', 'media', 'sparklestore-pro' ) ),
				'noTitle'            => _x( 'No Title', 'media', 'sparklestore-pro' ),
				'loadingUrl'         => admin_url( 'images/spinner.gif' ),
				'extensions'         => self::get_mime_extensions(),
				'select'             => apply_filters( 'rwmb_media_select_string', _x( 'Select Files', 'media', 'sparklestore-pro' ) ),
				'or'                 => apply_filters( 'rwmb_media_or_string', _x( 'or', 'media', 'sparklestore-pro' ) ),
				'uploadInstructions' => apply_filters( 'rwmb_media_upload_instructions_string', _x( 'Drop files here to upload', 'media', 'sparklestore-pro' ) ),
			)
		);
	}

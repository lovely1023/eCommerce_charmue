...
class RWMB_Select_Field extends RWMB_Choice_Field {
	...
	public static function get_select_all_html( $field ) {
		if ( $field['multiple'] && $field['select_all_none'] ) {
			return '<div class="rwmb-select-all-none">' . __( 'Select', 'sparklestore-pro' ) . ': <a data-type="all" href="#">' . __( 'All', 'sparklestore-pro' ) . '</a> | <a data-type="none" href="#">' . __( 'None', 'sparklestore-pro' ) . '</a></div>';
		}
		return '';
	}
}

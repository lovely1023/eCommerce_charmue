...
class Jet_Elements_Timeline extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Vertical Timeline', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'animate_cards',
			array(
				'label'        => esc_html__( 'Animate Cards', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_responsive_control(
			'horizontal_space',
			array(
				'label'      => esc_html__( 'Horizontal Space', 'sparklestore-pro' ),
		...
		$this->add_responsive_control(
			'vertical_space',
			array(
				'label'      => esc_html__( 'Vertical Space', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px',
				),
	...
	public function _control_section_card_content( $css_scheme ) {
		...
		$this->add_control(
			'card_arrow_heading',
			array(
				'label'     => esc_html__( 'Card Arrow', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => array(
		...
		$this->add_responsive_control(
			'card_arrow_offset',
			array(
				'label'      => esc_html__( 'Card Arrow Offset', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px',
					'%',
	...
	public function _control_section_line( $css_scheme ) {
		...
		$this->add_responsive_control(
			'line_width',
			array(
				'label'      => esc_html__( 'Thickness', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px',
				),

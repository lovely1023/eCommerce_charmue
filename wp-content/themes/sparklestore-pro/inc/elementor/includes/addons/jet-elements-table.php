...
class Jet_Elements_Table extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Table', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Table Header', 'sparklestore-pro' ),
			)
		);
		...
		$table_header_repeater->add_control(
			'add_icon_or_image',
			array(
				'label'   => esc_html__( 'Add icon/image', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '',
				'options' => array(
					''      => esc_html__( 'None', 'sparklestore-pro' ),
		...
		$table_header_repeater->start_controls_tab(
			'header_tab_advanced',
			array(
				'label' => esc_html__( 'Advanced', 'sparklestore-pro' ),
			)
		);
		...
		$table_header_repeater->add_control(
			'col_span',
			array(
				'label' => esc_html__( 'Column Span', 'sparklestore-pro' ),
		...
		$table_header_repeater->add_responsive_control(
			'col_width',
			array(
				'label' => esc_html__( 'Column Width', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				...
				'default' => array(
					array(
						'cell_text' => esc_html__( 'Heading #1', 'sparklestore-pro' ),
					),
					array(
						'cell_text' => esc_html__( 'Heading #2', 'sparklestore-pro' ),
					),
					array(
						'cell_text' => esc_html__( 'Heading #3', 'sparklestore-pro' ),
					),
				),
				'title_field' => esc_html__( 'Column: ', 'sparklestore-pro' ) . '{{ cell_text }}',
			)
		);
		...
		$this->start_controls_section(
			'section_table_body',
			array(
				'label' => esc_html__( 'Table Body', 'sparklestore-pro' ),
			)
		);
		...
		$table_body_repeater->add_control(
			'action',
			array(
				'label'   => esc_html__( 'Action', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'cell',
				'options' => array(
					'row'  => esc_html__( 'Start New Row', 'sparklestore-pro' ),
					'cell' => esc_html__( 'Add New Cell', 'sparklestore-pro' ),
				),
			)
		);
		...
		$table_body_repeater->add_control(
			'row_custom_style',
			array(
				'label' => esc_html__( 'Add Custom Style', 'sparklestore-pro' ),
		...
		$table_body_repeater->add_control(
			...
			array(
				...
				'placeholder' => esc_html__( 'https://your-link.com', 'sparklestore-pro' ),
				'condition' => array(
					'action' => 'cell',
				),
			)
		...
		$table_body_repeater->add_control(
			'row_span',
			array(
				'label' => esc_html__( 'Row Span', 'sparklestore-pro' ),
				'type'  => Controls_Manager::NUMBER,
				'min'   => 1,
				'step'  => 1,
				'condition' => array(
		...
		$table_body_repeater->add_control(
			'cell_is_th',
			array(
				'label' => esc_html__( 'This cell is Table Heading?', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SWITCHER,
				'condition' => array(
					'action' => 'cell',
				),
		...
		$table_body_repeater->add_control(
			'cell_is_th_desc',
			array(
				'raw'  => esc_html__( 'For this cell are applied table heading cell style', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				...
				'default' => array(
					...
					array(
						'action'    => 'cell',
						'cell_text' => esc_html__( 'Simple content', 'sparklestore-pro' ),
					),
					array(
						'action'    => 'cell',
						'cell_text' => esc_html__( 'Simple content', 'sparklestore-pro' ),
				...
				'title_field' => '{{ action === "row" ? "' . esc_html__( 'Start Row:', 'sparklestore-pro' ) . '" : "' . esc_html__( 'Cell:', 'sparklestore-pro' ) . ' " + cell_text }}',
			)
		);
		...
		$this->add_control(
			'sorting_table',
			array(
				'label'   => esc_html__( 'Sorting Table', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => '',
			)
		);
		...
		$this->add_control(
			'responsive_table',
			array(
				'label'   => esc_html__( 'Responsive Table', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => '',
			)
		);
		...
		$this->add_control(
			...
			array(
				'raw'  => esc_html__( 'Responsive table allow table to be scrolled horizontally.', 'sparklestore-pro' ),
				'type' => Controls_Manager::RAW_HTML,
				'content_classes' => 'elementor-descriptor',
				'condition'   => array(
		...
		$this->add_control(
			'responsive_table_on',
			array(
				'label'       => esc_html__( 'Responsive On', 'sparklestore-pro' ),
				'label_block' => true,
				'type'        => Controls_Manager::SELECT2,
				'multiple'    => true,
				'default'     => array( 'mobile' ),
				'options'     => array(
					'mobile'  => esc_html__( 'Mobile', 'sparklestore-pro' ),
					'tablet'  => esc_html__( 'Tablet', 'sparklestore-pro' ),
		...
		$this->add_responsive_control(
			'table_width',
			array(
				'label' => esc_html__( 'Table Width', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SLIDER,
				'size_units' => array( '%', 'px' ),
				'range' => array(
					'px' => array(
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					...
					'fixed' => esc_html__( 'Fixed (Equal width)', 'sparklestore-pro' ),
				),
				'default' => 'auto',
				'selectors' => array(
		...
		$this->add_responsive_control(
			'table_align',
			array(
				'label' => esc_html__( 'Table Alignment', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Hidden border for header container', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SWITCHER,
				'selectors'  => array(
		...
		$this->add_control(
			...
			array(
				'label' => '<b>' . esc_html__( 'Icon', 'sparklestore-pro' ) . '</b>',
		...
		$this->add_control(
			...
			array(
				'label' => '<b>' . esc_html__( 'Image', 'sparklestore-pro' ) . '</b>',
				'type'  => Controls_Manager::POPOVER_TOGGLE,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'sorting_icon_style',
			array(
				'label' => '<b>' . esc_html__( 'Sorting Icon', 'sparklestore-pro' ) . '</b>',
				'type'  => Controls_Manager::POPOVER_TOGGLE,
				'separator' => 'before',
				'condition' => array(
					'sorting_table' => 'yes',
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Row Color', 'sparklestore-pro' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Row Background Color', 'sparklestore-pro' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Striped rows', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SWITCHER,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Even Row Color', 'sparklestore-pro' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Even Row Background Color', 'sparklestore-pro' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Link Color', 'sparklestore-pro' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Row Hover Color', 'sparklestore-pro' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Row Hover Background Color', 'sparklestore-pro' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Even Row Hover Color', 'sparklestore-pro' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Even Row Hover Background Color', 'sparklestore-pro' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Cell Hover Color', 'sparklestore-pro' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Cell Hover Background Color', 'sparklestore-pro' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Link Hover Color', 'sparklestore-pro' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Hidden border for body container', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SWITCHER,
				'selectors'  => array(
	...
	public function get_table_cells( $data = array(), $context = 'head' ) {
		...
		foreach ( $data as $index => $item ) {
			if ( isset( $item['action'] ) && 'row' === $item['action'] ) {
				...
				$cell_text = ! empty( $item['cell_text'] ) ? sprintf( '<div class="jet-table__cell-text">%s</div>', $item['cell_text'] ) : '';

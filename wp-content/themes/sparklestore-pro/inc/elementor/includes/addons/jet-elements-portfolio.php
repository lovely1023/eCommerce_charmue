...
class Jet_Elements_Portfolio extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Portfolio', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'preset',
			array(
				'label'   => esc_html__( 'Preset', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'type-1',
				'options' => array(
					'type-1' => esc_html__( 'Type-1', 'sparklestore-pro' ),
					'type-2' => esc_html__( 'Type-2', 'sparklestore-pro' ),
					'type-3' => esc_html__( 'Type-3', 'sparklestore-pro' ),
					'type-4' => esc_html__( 'Type-4', 'sparklestore-pro' ),
				),
			)
		);
		...
		$this->add_control(
			'all_filter_label',
			array(
				'label'   => esc_html__( '`All` Filter Label', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'All', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_control(
			'view_more_button',
			array(
				'label'        => esc_html__( 'View More Button', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'View More Button Text', 'sparklestore-pro' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => esc_html__( 'View More', 'sparklestore-pro' ),
				'condition' => array(
		...
		$this->add_control(
			'per_page',
			array(
				'label'   => esc_html__( 'Item Per Page', 'sparklestore-pro' ),
		...
		$repeater->add_control(
			'item_category',
			array(
				'label'   => esc_html__( 'Category', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
		...
		if ( $use_retina ) {
			$repeater->add_control(
				'item_image_2x',
				array(
					'label'   => esc_html__( 'Retina Image', 'sparklestore-pro' ),
					'type'    => Controls_Manager::MEDIA,
					'default' => array(
						'url' => Utils::get_placeholder_image_src(),
					),
		...
		$repeater->add_control(
			'item_button_text',
			array(
				'label'   => esc_html__( 'Link Text', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
		...
		$repeater->add_control(
			'item_button_url',
			array(
				'label'       => esc_html__( 'Link Url', 'sparklestore-pro' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Filters', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Filters Container Styles', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Filters Items Styles', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__( 'Separator Icon', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Separator Color', 'sparklestore-pro' ),
		...
		$this->add_responsive_control(
			...
			array(
				'label' => esc_html__( 'Separator Size', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 1,
		...
		$this->add_responsive_control(
			...
			array(
				'label'       => esc_html__( 'Content Position', 'sparklestore-pro' ),
				'type'        => Controls_Manager::CHOOSE,
				'default'     => 'center',
				'label_block' => false,
				'options' => array(
		...
		$this->add_control(
			'show_category_list',
			array(
				'label'        => esc_html__( 'Show Category list', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Order', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'category_order',
			array(
				'label'   => esc_html__( 'Category Order', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 2,
				'min'     => 1,
				'max'     => 4,
		...
		$this->add_control(
			'button_order',
			array(
				'label'   => esc_html__( 'Button Order', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 4,
				'min'     => 1,
				'max'     => 4,
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'More Button', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Cover', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
				'condition' => array(
					'preset' => array(
		...
		$this->add_control(
			'cover_icon',
			array(
				'label'       => esc_html__( 'Cover Icon', 'sparklestore-pro' ),
				'type'        => Controls_Manager::ICON,
				'label_block' => true,
				'file'        => '',
		...
		$this->add_group_control(
			...
			array(
				'label'    => esc_html__( 'Cover Icon Style', 'sparklestore-pro' ),
	...
	protected function __loop_image_item() {
		...
		return sprintf( '<img class="jet-portfolio__image-instance" src="%1$s" width="%2$s" height="%3$s" %4$s alt="">', $params[0], $params[1], $params[2], $srcset );
	}
	...
	public function render_filters() {
		...
		$all_label = ( ! empty( $all_label ) ) ? $all_label : esc_html__( 'All', 'sparklestore-pro' );

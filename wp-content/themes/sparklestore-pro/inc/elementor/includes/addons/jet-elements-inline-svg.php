...
class Jet_Elements_Inline_Svg extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Inline SVG', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_svg_content',
			array(
				'label'      => esc_html__( 'SVG', 'sparklestore-pro' ),
		...
		$this->add_control(
			'svg_custom_width',
			array(
				'label'        => esc_html__( 'Use Custom Width', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'yes',
				'default'      => '',
				'description'  => esc_html__( 'Makes SVG responsive and allows to change its width.', 'sparklestore-pro' )
			)
		);
		...
		$this->add_control(
			'svg_aspect_ratio',
			array(
				'label'        => esc_html__( 'Use Aspect Ratio', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'yes',
				'default'      => 'yes',
				'description'  => esc_html__( 'This option allows your SVG item to be scaled up exactly as your bitmap image, at the same time saving its width compared to the height. ', 'sparklestore-pro' ),
				'condition'    => array(
		...
		$this->add_control(
			'svg_custom_color',
			array(
				'label'        => esc_html__( 'Use Custom Color', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'yes',
				'default'      => '',
				'description'  => esc_html__( 'Specifies color of all SVG elements that have a fill or stroke color set.', 'sparklestore-pro' )
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'        => esc_html__( 'Remove Inline CSS', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'yes',
				'default'      => '',
				'description'  => esc_html__( 'Use this option to delete the inline styles in the loaded SVG.', 'sparklestore-pro' )
			)
		);
	...
	protected function render() {
		...
		if ( 'svg' !== $ext ) {
			return printf( '<h5 class="jet-inline-svg__error">%s</h5>', esc_html__( 'Please choose a SVG file format.', 'sparklestore-pro' ) );
		}

...
class Jet_Elements_Booked_Appointments extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Booked Appointments', 'sparklestore-pro' );
	}
	...
	public function __atts() {
		...
		return array(
			'historic' => array(
				'label'   => esc_html__( 'Is Past Appointments?', 'sparklestore-pro' ),
			...
			'remove_wrapper' => array(
				'label'   => esc_html__( 'Remove HTML wrappers', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'on'  => esc_html__( 'Yes', 'sparklestore-pro' ),
					'off' => esc_html__( 'No', 'sparklestore-pro' ),

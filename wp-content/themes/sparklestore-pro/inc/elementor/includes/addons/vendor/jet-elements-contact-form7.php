...
class Jet_Elements_Contact_Form7 extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Contact Form 7', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_settings',
			array(
				'label' => esc_html__( 'Form', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_control( 'form_shortcode', array(
			'label'   => esc_html__( 'Select Form', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				...
				'raw'  => sprintf(
					esc_html__( 'In case you want to create the more complex contact form layout, please, feel free to use %s tool', 'sparklestore-pro' ),
					'<a target="_blank" href="https://crocoblock.com/contact-form-7-layout-builder/">' . esc_html__( 'Contact Form 7 Layout Builder', 'sparklestore-pro' ) . '</a>'
				)
			)
		);
		...
		$this->start_controls_section(
			'section_text_style',
			array(
				'label'      => esc_html__( 'Form Texts', 'sparklestore-pro' ),
		...
		$this->add_control(
			'invalid_heading',
			array(
				'label'     => esc_html__( 'Not Valid Notices', 'sparklestore-pro' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Controls', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Placeholder Color', 'sparklestore-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->start_controls_tab(
			'tab_input_focus',
			array(
				'label' => esc_html__( 'Focus', 'sparklestore-pro' ),
			)
		);
		...
		$this->start_controls_tab(
			'tab_input_invalid',
			array(
				'label' => esc_html__( 'Not Valid', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_responsive_control(
			'textarea_min_height',
			array(
				'label'       => esc_html__( 'Textarea Minimal Height', 'sparklestore-pro' ),
				'label_block' => true,
		...
		$this->start_controls_section(
			'submit_style',
			array(
				'label'      => esc_html__( 'Submit Button', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			'submit_bg',
			array(
				'label'       => _x( 'Background Type', 'Background Control', 'sparklestore-pro' ),
				'type'        => Controls_Manager::CHOOSE,
				'options'     => array(
					'color' => array(
						'title' => _x( 'Classic', 'Background Control', 'sparklestore-pro' ),
						'icon'  => 'fa fa-paint-brush',
					),
					'gradient' => array(
						'title' => _x( 'Gradient', 'Background Control', 'sparklestore-pro' ),
						'icon'  => 'fa fa-barcode',
					),
				),
				'default'     => 'color',
		...
		$this->add_control(
			'submit_bg_color',
			array(
				'label'     => _x( 'Color', 'Background Control', 'sparklestore-pro' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'scheme'    => array(
				...
				'title'     => _x( 'Background Color', 'Background Control', 'sparklestore-pro' ),
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'      => _x( 'Location', 'Background Control', 'sparklestore-pro' ),
		...
		$this->add_control(
			'submit_bg_color_b',
			array(
				'label'       => _x( 'Second Color', 'Background Control', 'sparklestore-pro' ),
				'type'        => Controls_Manager::COLOR,
				'default'     => '#f2295b',
				'render_type' => 'ui',
				'condition'   => array(
		...
		$this->add_control(
			...
			array(
				'label'   => _x( 'Type', 'Background Control', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'linear' => _x( 'Linear', 'Background Control', 'sparklestore-pro' ),
					'radial' => _x( 'Radial', 'Background Control', 'sparklestore-pro' ),
				),
				'default'     => 'linear',
				'render_type' => 'ui',
				'condition'   => array(
		...
		$this->add_control(
			...
			array(
				'label'      => _x( 'Angle', 'Background Control', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
		...
		$this->add_control(
			...
			array(
				'label'   => _x( 'Position', 'Background Control', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'center center' => _x( 'Center Center', 'Background Control', 'sparklestore-pro' ),
					'center left'   => _x( 'Center Left', 'Background Control', 'sparklestore-pro' ),
					'center right'  => _x( 'Center Right', 'Background Control', 'sparklestore-pro' ),
					'top center'    => _x( 'Top Center', 'Background Control', 'sparklestore-pro' ),
					'top left'      => _x( 'Top Left', 'Background Control', 'sparklestore-pro' ),
					'top right'     => _x( 'Top Right', 'Background Control', 'sparklestore-pro' ),
					'bottom center' => _x( 'Bottom Center', 'Background Control', 'sparklestore-pro' ),
					'bottom left'   => _x( 'Bottom Left', 'Background Control', 'sparklestore-pro' ),
					'bottom right'  => _x( 'Bottom Right', 'Background Control', 'sparklestore-pro' ),
				),
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					...
					'underline' => esc_html__( 'Underline', 'sparklestore-pro' ),
				),
				'default' => 'none',
				'selectors' => array(
		...
		$this->add_group_control(
			...
			array(
				...
				'label' => esc_html__( 'Typography', 'sparklestore-pro' ),
		...
		$this->add_control(
			'arrows',
			array(
				'label'        => esc_html__( 'Fullwidth Button', 'sparklestore-pro' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Alerts', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			'sent_heading',
			array(
				'label'     => esc_html__( 'Sent Success', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'error_heading',
			array(
				'label'     => esc_html__( 'Sent Error', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'spam_heading',
			array(
				'label'     => esc_html__( 'Spam Blocked', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);

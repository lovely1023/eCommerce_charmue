...
class Jet_Elements_Smartslider3 extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Smart Slider', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_slider',
			array(
				'label' => esc_html__( 'Slider', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_control(
			'slider',
			array(
				'label'   => esc_html__( 'Select slider', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				...
				'raw'  => __( '<strong>Note:</strong> In Editor mode slider will be appended only as preview image to speed up the editing. On frontend slider will be shown as usual slider.', 'sparklestore-pro' ),
			)
		);
	...
	protected function render() {
		...
		$placeholder  = esc_html__( 'Please, select slider to show', 'sparklestore-pro' );

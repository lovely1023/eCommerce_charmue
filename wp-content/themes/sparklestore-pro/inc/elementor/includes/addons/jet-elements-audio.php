...
class Jet_Elements_Audio extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Audio Player', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_audio',
			array(
				'label' => esc_html__( 'Audio', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_control(
			'audio_source',
			array(
				'label'   => esc_html__( 'Audio Source', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'self',
				'options' => array(
					'self'     => esc_html__( 'Self Hosted', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				...
				'raw'  => esc_html__( 'Audio Player support MP3 audio format', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Audio Options', 'sparklestore-pro' ),
		...
		$this->add_control(
			'muted',
			array(
				'label' => esc_html__( 'Muted', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SWITCHER,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Controls Options', 'sparklestore-pro' ),
				'type'  => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'progress',
			array(
				'label'   => esc_html__( 'Progress Bar', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
			)
		);
		...
		$this->add_control(
			'current',
			array(
				'label'   => esc_html__( 'Current Time', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
			)
		);
		...
		$this->add_control(
			'duration',
			array(
				'label'   => esc_html__( 'Duration Time', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
			)
		);
		...
		$this->add_control(
			'volume',
			array(
				'label'   => esc_html__( 'Volume', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Hide Volume On Touch Devices', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'condition' => array(
					'volume' => 'yes',
		...
		$this->add_control(
			'volume_bar',
			array(
				'label'   => esc_html__( 'Volume Bar', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
		...
		$this->add_control(
			'volume_bar_layout',
			array(
				'label'   => esc_html__( 'Volume Bar Layout', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'horizontal',
				'options' => array(
		...
		$this->add_control(
			'start_volume',
			array(
				'label'       => esc_html__( 'Start Volume', 'sparklestore-pro' ),
				'description' => esc_html__( 'Initial volume when the player starts. Override by user cookie.', 'sparklestore-pro' ),
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Play-Pause Button and Time', 'sparklestore-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Progress', 'sparklestore-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'progress' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Volume Handle', 'sparklestore-pro' ),
				'type'  => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => array(
					'volume' => 'yes',

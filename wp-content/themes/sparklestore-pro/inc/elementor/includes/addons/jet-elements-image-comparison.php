...
class Jet_Elements_Image_Comparison extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Image Comparison', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			'item_before_label',
			array(
				'label'   => esc_html__( 'Before Label', 'sparklestore-pro' ),
		...
		$repeater->add_control(
			'item_after_label',
			array(
				'label'   => esc_html__( 'After Label', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'     => array(
					array(
						'item_before_label' => esc_html__( 'Before', 'sparklestore-pro' ),
						'item_before_image' => array(
							'url' => Utils::get_placeholder_image_src(),
						),
						'item_after_label' => esc_html__( 'After', 'sparklestore-pro' ),
		...
		$this->start_controls_tab(
			'tab_label_before',
			array(
				'label' => esc_html__( 'Before', 'sparklestore-pro' ),
			)
		);
		...
		$this->start_controls_tab(
			'tab_label_after',
			array(
				'label' => esc_html__( 'After', 'sparklestore-pro' ),
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Handle', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Control Width', 'sparklestore-pro' ),
		...
		$this->add_control(
			'handle_arrow_color',
			array(
				'label' => esc_html__( 'Arrow Color', 'sparklestore-pro' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Handle Divider', 'sparklestore-pro' ),
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Divider Width', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Divider Color', 'sparklestore-pro' ),
				'type'    => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_responsive_control(
			'starting_position',
			array(
				'label'      => esc_html__( 'Divider Starting Position', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( '%' ),
				'range'      => array(
					'%' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Handle Arrow', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);

...
class Jet_Elements_Testimonials extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonials', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			'slides_to_show',
			array(
				'label'   => esc_html__( 'Slides to Show', 'sparklestore-pro' ),
		...
		$this->add_control(
			'slides_to_scroll',
			array(
				'label'     => esc_html__( 'Slides to Scroll', 'sparklestore-pro' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '1',
				'options'   => jet_elements_tools()->get_select_range( 10 ),
				'condition' => array(
		...
		$this->add_control(
			'pause_on_hover',
			array(
				'label'        => esc_html__( 'Pause on Hover', 'sparklestore-pro' ),
		...
		$this->add_control(
			'autoplay_speed',
			array(
				'label'     => esc_html__( 'Autoplay Speed', 'sparklestore-pro' ),
		...
		$this->add_control(
			'infinite',
			array(
				'label'        => esc_html__( 'Infinite Loop', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'adaptive_height',
			array(
				'label'        => esc_html__( 'Adaptive Height', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'effect',
			array(
				'label'   => esc_html__( 'Effect', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'slide',
				'options' => array(
		...
		$this->add_control(
			'speed',
			array(
				'label'   => esc_html__( 'Animation Speed', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 500,
			)
		);
		...
		$this->add_control(
			'arrows',
			array(
				'label'        => esc_html__( 'Show Arrows Navigation', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'prev_arrow',
			array(
				'label'   => esc_html__( 'Prev Arrow Icon', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
		...
		$this->add_control(
			'next_arrow',
			array(
				'label'   => esc_html__( 'Next Arrow Icon', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
		...
		$this->add_control(
			'dots',
			array(
				'label'        => esc_html__( 'Show Dots Navigation', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$repeater->add_control(
			'item_comment',
			array(
				'label'   => esc_html__( 'Comment', 'sparklestore-pro' ),
		...
		$repeater->add_control(
			'item_name',
			array(
				'label'   => esc_html__( 'Name', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$repeater->add_control(
			'item_date',
			array(
				'label'   => esc_html__( 'Date', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default'     => array(
					array(
						'item_comment'  => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'sparklestore-pro' ),
						'item_name'     => esc_html__( 'Mary Scott', 'sparklestore-pro' ),
						'item_position' => esc_html__( 'Founder & CEO', 'sparklestore-pro' ),
						'item_date'     => esc_html__( 'Thursday, August 31, 2017', 'sparklestore-pro' ),
					),
					array(
						'item_comment'  => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'sparklestore-pro' ),
						'item_name'     => esc_html__( 'John Borthwick', 'sparklestore-pro' ),
						'item_position' => esc_html__( 'Founder & CEO', 'sparklestore-pro' ),
						'item_date'     => esc_html__( 'Thursday, August 31, 2017', 'sparklestore-pro' ),
					),
					array(
						'item_comment'  => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'sparklestore-pro' ),
						'item_name'     => esc_html__( 'Jane Bill', 'sparklestore-pro' ),
						'item_position' => esc_html__( 'Founder & CEO', 'sparklestore-pro' ),
						'item_date'     => esc_html__( 'Thursday, August 31, 2017', 'sparklestore-pro' ),
					),
					array(
						'item_comment'  => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'sparklestore-pro' ),
						'item_name'     => esc_html__( 'David Anderson', 'sparklestore-pro' ),
						'item_position' => esc_html__( 'Founder & CEO', 'sparklestore-pro' ),
						'item_date'     => esc_html__( 'Thursday, August 31, 2017', 'sparklestore-pro' ),
					),
					array(
						'item_comment'  => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'sparklestore-pro' ),
						'item_name'     => esc_html__( 'Susan O’Neill', 'sparklestore-pro' ),
						'item_position' => esc_html__( 'Founder & CEO', 'sparklestore-pro' ),
						'item_date'     => esc_html__( 'Thursday, August 31, 2017', 'sparklestore-pro' ),
					),
					array(
						'item_comment'  => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'sparklestore-pro' ),
						'item_name'     => esc_html__( 'Ryan King', 'sparklestore-pro' ),
						'item_position' => esc_html__( 'Founder & CEO', 'sparklestore-pro' ),
						'item_date'     => esc_html__( 'Thursday, August 31, 2017', 'sparklestore-pro' ),
					),
				),
		...
		$this->add_control(
			'equal_height_cols',
			array(
				'label'        => esc_html__( 'Equal Items Height', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'item_margin',
			array(
				'label'       => esc_html__( 'Item Margin', 'sparklestore-pro' ),
				'type'        => Controls_Manager::DIMENSIONS,
				'size_units'  => array( 'px' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Arrows', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'           => 'arrows_style',
				'label'          => esc_html__( 'Arrows Style', 'sparklestore-pro' ),
		...
		$this->add_control(
			'prev_arrow_position',
			array(
				'label'     => esc_html__( 'Prev Arrow Position', 'sparklestore-pro' ),
		...
		$this->add_control(
			'prev_vert_position',
			array(
				'label'   => esc_html__( 'Vertical Position by', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'top',
				'options' => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Bottom Indent', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%', 'em' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			'prev_hor_position',
			array(
				'label'   => esc_html__( 'Horizontal Position by', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'left',
				'options' => array(
		...
		$this->add_control(
			'next_arrow_position',
			array(
				'label'     => esc_html__( 'Next Arrow Position', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'dots_margin',
			array(
				'label'      => esc_html__( 'Dots Box Margin', 'sparklestore-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->add_control(
			'title_custom_width',
			array(
				'label'        => esc_html__( 'Custom width', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'use_comment_corner',
			array(
				'label'        => esc_html__( 'Use comment corner', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'yes',
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Corner Position', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( '%' ),
				'range'      => array(
					'%' => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Corner Width', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Corner Height', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_responsive_control(
			'comment_corner_skew',
			array(
				'label'      => esc_html__( 'Corner Skew', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			'image_order',
			array(
				'label'   => esc_html__( 'Image Order', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 1,
				'min'     => 1,
				'max'     => 7,
		...
		$this->add_control(
			'icon_order',
			array(
				'label'   => esc_html__( 'Icon Order', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 2,
				'min'     => 1,
				'max'     => 7,
		...
		$this->add_control(
			'name_order',
			array(
				'label'   => esc_html__( 'Name Order', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 5,
				'min'     => 1,
				'max'     => 7,
		...
		$this->add_control(
			'position_order',
			array(
				'label'   => esc_html__( 'Position Order', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 6,
				'min'     => 1,
				'max'     => 7,
		...
		$this->add_control(
			'date_order',
			array(
				'label'   => esc_html__( 'Date Order', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 7,
				'min'     => 1,
				'max'     => 7,

...
class Jet_Elements_Services extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Services', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$this->add_control(
			'icon_cover_location',
			array(
				'label'        => esc_html__( 'Display in header', 'sparklestore-pro' ),
		...
		$this->add_control(
			'use_title_icon',
			array(
				'label'        => esc_html__( 'Use title icon?', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'title_icon',
			array(
				'label'       => esc_html__( 'Title Icon', 'sparklestore-pro' ),
				'type'        => Controls_Manager::ICON,
				'label_block' => true,
				'file'        => '',
				'default'     => '',
		...
		$this->add_responsive_control(
			'title_icon_margin',
			array(
				'label'      => __( 'Icon Margin', 'sparklestore-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(

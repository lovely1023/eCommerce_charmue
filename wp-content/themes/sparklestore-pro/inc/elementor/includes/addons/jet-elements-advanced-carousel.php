...
class Jet_Elements_Advanced_Carousel extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Advanced Carousel', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_slides',
			array(
				'label' => esc_html__( 'Slides', 'sparklestore-pro' ),
			)
		);
		...
		$repeater->add_control(
			'item_title',
			array(
				'label'   => esc_html__( 'Item Title', 'sparklestore-pro' ),
		...
		$repeater->add_control(
			'item_text',
			array(
				'label'   => esc_html__( 'Item Description', 'sparklestore-pro' ),
		...
		$repeater->add_control(
			'item_link',
			array(
				'label'   => esc_html__( 'Item Link', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'dynamic' => array(
					'active' => true,
					'categories' => array(
		...
		$repeater->add_control(
			'item_button_text',
			array(
				'label'   => esc_html__( 'Item Button Text', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '',
			)
		);
			...
			array(
				...
				'default'     => array(
					array(
						...
						'item_text'  => esc_html__( 'Item #1 Description', 'sparklestore-pro' ),
						'item_link'  => '#',
						'item_link_target'  => '',
					),
				),
		...
		$this->add_control(
			'item_layout',
			array(
				'label'   => esc_html__( 'Items Layout', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'simple',
				'options' => array(
					'banners'=> esc_html__( 'Banners', 'sparklestore-pro' ),
					'simple' => esc_html__( 'Simple', 'sparklestore-pro' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				'type'       => 'select',
				'label'      => esc_html__( 'Images Size', 'sparklestore-pro' ),
				'default'    => 'full',
		...
		$this->add_control(
			'equal_height_cols',
			array(
				'label'        => esc_html__( 'Equal Columns Height', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'fluid_width',
			array(
				'label'        => esc_html__( 'Fluid Columns Width', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Additional Options', 'sparklestore-pro' ),
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Column', 'sparklestore-pro' ),
		...
		$this->add_control(
			'column_padding',
			array(
				'label'       => esc_html__( 'Column Padding', 'sparklestore-pro' ),
		...
		$this->add_control(
			'column_margin',
			array(
				'label'       => esc_html__( 'Column Margin', 'sparklestore-pro' ),
				'type'        => Controls_Manager::DIMENSIONS,
				'size_units'  => array( 'px' ),
				'selectors'   => array(
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Simple Items', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
				'condition'  => array(
					'item_layout' => 'simple',
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Banner Items', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
				'condition'  => array(
					'item_layout' => 'banners',
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Items Title Typography', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			'items_title_color',
			array(
				'label'     => esc_html__( 'Items Title Color', 'sparklestore-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Items Content Typography', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			'items_text_color',
			array(
				'label'     => esc_html__( 'Items Content Color', 'sparklestore-pro' ),
				'type'      => Controls_Manager::COLOR,
				'scheme'    => array(
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Carousel Arrows', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->start_controls_section(
			'section_dots_style',
			array(
				'label'      => esc_html__( 'Carousel Dots', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);

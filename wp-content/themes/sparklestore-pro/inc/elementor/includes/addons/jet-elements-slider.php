...
class Jet_Elements_Slider extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			...
			array(
				'label'   => esc_html__( 'Primary Button URL', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '',
				'dynamic' => array(
					'active' => true,
		...
		$repeater->add_control(
			...
			array(
				'label'   => esc_html__( 'Primary Button Text', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'More', 'sparklestore-pro' ),
			)
		);
		...
		$repeater->add_control(
			...
			array(
				'label'   => esc_html__( 'Secondary Button URL', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '',
				'dynamic' => array(
					'active' => true,
		...
		$repeater->add_control(
			...
			array(
				'label'   => esc_html__( 'Secondary Button Text', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'More', 'sparklestore-pro' ),
			)
		);
			...
			array(
				...
				'default'     => array(
					array(
						...
						'item_title'                 => esc_html__( 'Slide #1', 'sparklestore-pro' ),
						'item_subtitle'              => esc_html__( 'SubTitle', 'sparklestore-pro' ),
						'item_desc'                  => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'sparklestore-pro' ),
						'item_button_primary_url'    => '#',
						'item_button_primary_text'   => esc_html__( 'Button #1', 'sparklestore-pro' ),
						'item_button_secondary_ulr'  => '#',
						'item_button_secondary_text' => esc_html__( 'Button #2', 'sparklestore-pro' ),
						),
					array(
						'item_image'                 => array(
							'url' => Utils::get_placeholder_image_src(),
						),
						'item_title'                 => esc_html__( 'Slide #2', 'sparklestore-pro' ),
						'item_subtitle'              => esc_html__( 'SubTitle', 'sparklestore-pro' ),
						'item_desc'                  => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'sparklestore-pro' ),
						'item_button_primary_url'    => '#',
						'item_button_primary_text'   => esc_html__( 'Button #1', 'sparklestore-pro' ),
					...
					array(
						...
						'item_title'                 => esc_html__( 'Slide #3', 'sparklestore-pro' ),
						'item_subtitle'              => esc_html__( 'SubTitle', 'sparklestore-pro' ),
						'item_desc'                  => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', 'sparklestore-pro' ),
						'item_button_primary_url'    => '#',
						'item_button_primary_text'   => esc_html__( 'Button #1', 'sparklestore-pro' ),
		...
		$this->add_control(
			'slider_navigation',
			array(
				'label'        => esc_html__( 'Use navigation?', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				'label'        => esc_html__( 'Indicates whether the arrows will fade in only on hover', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'slider_pagination',
			array(
				'label'        => esc_html__( 'Use pagination?', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'slider_autoplay',
			array(
				'label'        => esc_html__( 'Use autoplay?', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Autoplay delay(ms)', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Autoplay On Hover', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'pause',
				'options' => array(
					'none'  => esc_html__( 'None', 'sparklestore-pro' ),
					'pause' => esc_html__( 'Pause', 'sparklestore-pro' ),
					'stop'  => esc_html__( 'Stop', 'sparklestore-pro' ),
				),
			)
		);
		...
		$this->add_control(
			'slider_fullScreen',
			array(
				'label'        => esc_html__( 'Display fullScreen button?', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'slider_shuffle',
			array(
				'label'        => esc_html__( 'Indicates if the slides will be shuffled', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'slider_loop',
			array(
				'label'        => esc_html__( 'Indicates if the slides will be looped', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'slider_fade_mode',
			array(
				'label'        => esc_html__( 'Use fade effect?', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'slide_distance',
			array(
				'label' => esc_html__( ' Between Slides Distance', 'sparklestore-pro' ),
		...
		$this->add_control(
			'slide_duration',
			array(
				'label'   => esc_html__( 'Slide Duration(ms)', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 500,
				'min'     => 100,
				'max'     => 5000,
		...
		$this->add_control(
			'thumbnails',
			array(
				'label'        => esc_html__( 'Display thumbnails?', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'true',
		...
		$this->add_control(
			'thumbnail_width',
			array(
				'label'   => esc_html__( 'Thumbnail width(px)', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 120,
				'min'     => 20,
				'max'     => 200,
		...
		$this->add_control(
			'thumbnail_height',
			array(
				'label'   => esc_html__( 'Thumbnail height(px)', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 80,
				'min'     => 20,
				'max'     => 200,
		...
		$this->add_control(
			'slider_width',
			array(
				'label' => esc_html__( 'Slider Width(%)', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => array(
					'%' => array(
						'min' => 50,
		...
		$this->add_responsive_control(
			'slider_height',
			array(
				'label' => esc_html__( 'Slider Height(px)', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SLIDER,
				'size_units' => array(
					'px', 'vh',
				),
		...
		$this->add_responsive_control(
			...
			array(
				'label' => esc_html__( 'Slider Container Width(%)', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SLIDER,
				'size_units' => array(
					'%', 'px',
				),
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Image Scale Mode', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'exact',
				'options' => array(
					'exact'   => esc_html__( 'Cover', 'sparklestore-pro' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Navigation', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Arrow Icon', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Box Size', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px', 'em', '%',
				),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Pagination', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				'label'   => esc_html__( 'Pagination Container Offset', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'min'     => -500,
				'max'     => 500,
				'step'    => 1,
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Thumbnails', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Thumbnails Container Offset', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'min'     => -500,
				'max'     => 500,
				'step'    => 1,
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Fullscreen', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				'label' => esc_html__( 'Max Width', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%' ),
				'range' => array(
					'%' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Action Button #1', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Action Button #2', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);

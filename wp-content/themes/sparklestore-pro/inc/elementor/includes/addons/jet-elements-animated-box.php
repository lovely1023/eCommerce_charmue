...
class Jet_Elements_Animated_Box extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Animated Box', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Front Side Content', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Flip Box', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default' => esc_html__( 'Easily add or remove any text on your flip box!', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Back Side Content', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Title', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Back Side', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'jet-box-effect-1'  => esc_html__( 'Flip Horizontal', 'sparklestore-pro' ),
					'jet-box-effect-2'  => esc_html__( 'Flip Vertical', 'sparklestore-pro' ),
					'jet-box-effect-3'  => esc_html__( 'Fall Up', 'sparklestore-pro' ),
					'jet-box-effect-4'  => esc_html__( 'Fall Right', 'sparklestore-pro' ),
					'jet-box-effect-5'  => esc_html__( 'Slide Down', 'sparklestore-pro' ),
					'jet-box-effect-6'  => esc_html__( 'Slide Right', 'sparklestore-pro' ),
					'jet-box-effect-7'  => esc_html__( 'Flip Horizontal 3D', 'sparklestore-pro' ),
					'jet-box-effect-8'  => esc_html__( 'Flip Vertical 3D', 'sparklestore-pro' ),
				),
			)
		);
		...
		$this->add_control(
			'sub_title_html_tag',
			array(
				'label'   => esc_html__( 'Subtitle HTML Tag', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'h1'   => esc_html__( 'H1', 'sparklestore-pro' ),
					'h2'   => esc_html__( 'H2', 'sparklestore-pro' ),
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Front', 'sparklestore-pro' ),
			)
		);
		...
		$this->start_controls_tab(
			...
			array(
				'label' => esc_html__( 'Back', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'before'  => esc_html__( 'Before Text', 'sparklestore-pro' ),
					'after' => esc_html__( 'After Text', 'sparklestore-pro' ),
				),
				'default'     => 'after',

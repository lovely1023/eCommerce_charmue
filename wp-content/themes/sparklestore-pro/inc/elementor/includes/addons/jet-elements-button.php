...
class Jet_Elements_Button extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Button', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'button_label_normal',
			array(
				'label'       => esc_html__( 'Button Label Text', 'sparklestore-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Click Me', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__( 'Button Label Text', 'sparklestore-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Go', 'sparklestore-pro' ),
				'dynamic'     => array( 'active' => true ),
			)
		);
		...
		$effects = apply_filters(
			...
			array(
				'effect-0'  => esc_html__( 'None', 'sparklestore-pro' ),
				'effect-1'  => esc_html__( 'Fade', 'sparklestore-pro' ),
				'effect-2'  => esc_html__( 'Up Slide', 'sparklestore-pro' ),
				'effect-3'  => esc_html__( 'Down Slide', 'sparklestore-pro' ),
				'effect-4'  => esc_html__( 'Right Slide', 'sparklestore-pro' ),
				'effect-5'  => esc_html__( 'Left Slide', 'sparklestore-pro' ),
				'effect-6'  => esc_html__( 'Up Scale', 'sparklestore-pro' ),
				'effect-7'  => esc_html__( 'Down Scale', 'sparklestore-pro' ),
				'effect-8'  => esc_html__( 'Top Diagonal Slide', 'sparklestore-pro' ),
				'effect-9'  => esc_html__( 'Bottom Diagonal Slide', 'sparklestore-pro' ),
				'effect-10' => esc_html__( 'Right Rayen', 'sparklestore-pro' ),
				'effect-11' => esc_html__( 'Left Rayen', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_control(
			'hover_effect',
			array(
				'label'   => esc_html__( 'Hover Effect', 'sparklestore-pro' ),
		...
		$this->add_control(
			'use_button_icon',
			array(
				'label'        => esc_html__( 'Use Icon?', 'sparklestore-pro' ),
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Custom Height', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px', 'em', '%',
				),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Plane', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Icon Box Width', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px', 'em', '%',
				),
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Icon Box Height', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px', 'em', '%',
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Icon Box Color', 'sparklestore-pro' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => array(

...
class Jet_Elements_Animated_Text extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Animated Text', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'before_text_content',
			array(
				'label'   => esc_html__( 'Before Text', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Let us', 'sparklestore-pro' ),
		...
		$repeater->add_control(
			...
			array(
				...
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Create', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'label'   => esc_html__( 'Animated Text', 'sparklestore-pro' ),
				'fields'  => array_values( $repeater->get_controls() ),
				'default' => array(
					array(
						'item_text' => esc_html__( 'Create', 'sparklestore-pro' ),
					),
					array(
						'item_text' => esc_html__( 'Animate', 'sparklestore-pro' ),
					),
				),
		...
		$this->add_control(
			'after_text_content',
			array(
				'label'   => esc_html__( 'After Text', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'your text', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'fx1',
				'options' => array(
					'fx1'  => esc_html__( 'Joke', 'sparklestore-pro' ),
					'fx2'  => esc_html__( 'Kinnect', 'sparklestore-pro' ),
					'fx3'  => esc_html__( 'Circus', 'sparklestore-pro' ),
					'fx4'  => esc_html__( 'Rotation fall', 'sparklestore-pro' ),
					'fx5'  => esc_html__( 'Simple Fall', 'sparklestore-pro' ),
					'fx6'  => esc_html__( 'Rotation', 'sparklestore-pro' ),
					'fx7'  => esc_html__( 'Anime', 'sparklestore-pro' ),
					'fx8'  => esc_html__( 'Label', 'sparklestore-pro' ),
					'fx9'  => esc_html__( 'Croco', 'sparklestore-pro' ),
					'fx10' => esc_html__( 'Scaling', 'sparklestore-pro' ),
					'fx11' => esc_html__( 'Fun', 'sparklestore-pro' ),
					'fx12' => esc_html__( 'Typing', 'sparklestore-pro' ),
				),
			)
		);
		...
		$this->add_control(
			'animation_delay',
			array(
				'label'   => esc_html__( 'Animation delay', 'sparklestore-pro' ),
		...
		$this->add_control(
			'split_type',
			array(
				'label'   => esc_html__( 'Split Type', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'symbol',
				'options' => array(
					'symbol' => esc_html__( 'Symbols', 'sparklestore-pro' ),
					'word'   => esc_html__( 'Words', 'sparklestore-pro' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Cursor Color', 'sparklestore-pro' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => array(
					'type'  => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,

...
class Jet_Elements_Instagram_Gallery extends Jet_Elements_Base {
    ...
    public function get_title() {
        return esc_html__('Instagram', 'sparklestore-pro');
    }
    ...
    protected function _register_controls() {
        ...
        $css_scheme = apply_filters(
                'jet-elements/instagram-gallery/css-scheme', array(
        ...
        $this->start_controls_section(
            ...
            'label' => esc_html__('Instagram Settings', 'sparklestore-pro'),
                )
        );

        $this->add_control(
                'endpoint', array(
            'label' => esc_html__('What to display', 'sparklestore-pro'),
            'type' => Controls_Manager::SELECT,
            'default' => 'hashtag',
            'options' => array(
                'hashtag' => esc_html__('Tagged Photos', 'sparklestore-pro'),
                'self' => esc_html__('My Photos', 'sparklestore-pro'),
            ),
                )
        );
        ...
        $this->add_control(
                'hashtag', array(
            'label' => esc_html__('Hashtag (enter without `#` symbol)', 'sparklestore-pro'),
...
//			'self',
//			array(
//				'label' => esc_html__( 'Username', 'sparklestore-pro' ),
//				'type'  => Controls_Manager::TEXT,
//				'condition' => array(
//					'endpoint' => 'self',
//				),
...
//		);
        ...
        if (!$this->get_access_token()) {
            $this->add_control(
                    'set_access_token', array(
                'type' => Controls_Manager::RAW_HTML,
                'raw' => sprintf(
                        esc_html__('Please set Instagram Access Token on the %1$s.', 'sparklestore-pro'), '<a target="_blank" href="' . admin_url('/admin.php?page=sparklestore-pro-options') . '">' . esc_html__('settings page', 'sparklestore-pro') . '</a>'
                ),
                'condition' => array(
                    'endpoint' => 'self',
                ),
        ...
        $this->add_control(
                'cache_timeout', array(
            'label' => esc_html__('Cache Timeout', 'sparklestore-pro'),
            'type' => Controls_Manager::SELECT,
            'default' => 'hour',
            'options' => array(
                'none' => esc_html__('None', 'sparklestore-pro'),
                'minute' => esc_html__('Minute', 'sparklestore-pro'),
                'hour' => esc_html__('Hour', 'sparklestore-pro'),
                'day' => esc_html__('Day', 'sparklestore-pro'),
                'week' => esc_html__('Week', 'sparklestore-pro'),
            ),
                )
        );
        ...
        $this->add_control(
                'photo_size', array(
            'label' => esc_html__('Photo Size', 'sparklestore-pro'),
            'type' => Controls_Manager::SELECT,
            'default' => 'high',
            'options' => array(
                'thumbnail' => esc_html__('Thumbnail (150x150)', 'sparklestore-pro'),
                'low' => esc_html__('Low (320x320)', 'sparklestore-pro'),
                'standard' => esc_html__('Standard (640x640)', 'sparklestore-pro'),
                'high' => esc_html__('High (original)', 'sparklestore-pro'),
            ),
                )
        );
        ...
        $this->add_control(
                'posts_counter', array(
            'label' => esc_html__('Number of instagram posts', 'sparklestore-pro'),
        ...
        $this->add_control(
                'post_link', array(
            'label' => esc_html__('Enable linking photos', 'sparklestore-pro'),
        ...
        $this->add_control(
                'post_caption', array(
            'label' => esc_html__('Enable caption', 'sparklestore-pro'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => esc_html__('Yes', 'sparklestore-pro'),
            'label_off' => esc_html__('No', 'sparklestore-pro'),
            'return_value' => 'yes',
        ...
        $this->add_control(
                'post_caption_length', array(
            'label' => esc_html__('Caption length', 'sparklestore-pro'),
            'type' => Controls_Manager::NUMBER,
            'default' => 50,
            'min' => 1,
            'max' => 300,
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Enable Comments Count', 'sparklestore-pro'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => esc_html__('Yes', 'sparklestore-pro'),
            'label_off' => esc_html__('No', 'sparklestore-pro'),
            'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Enable Likes Count', 'sparklestore-pro'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => esc_html__('Yes', 'sparklestore-pro'),
            'label_off' => esc_html__('No', 'sparklestore-pro'),
            'return_value' => 'yes',
         ...
         */
        $this->start_controls_section(
                'section_caption_style', array(
            'label' => esc_html__('Caption', 'sparklestore-pro'),
            'tab' => Controls_Manager::TAB_STYLE,
            'show_label' => false,
                )
        );
        ...
        $this->add_responsive_control(
                'caption_width', array(
            'label' => esc_html__('Caption Width', 'sparklestore-pro'),
            'type' => Controls_Manager::SLIDER,
            'size_units' => array(
                'px', 'em', '%',
            ),
         ...
         */
        $this->start_controls_section(
                'section_meta_style', array(
            'label' => esc_html__('Meta', 'sparklestore-pro'),
            'tab' => Controls_Manager::TAB_STYLE,
            'show_label' => false,
                )
        );
        ...
        $this->add_control(
                'comments_icon', array(
            'label' => esc_html__('Comments Icon', 'sparklestore-pro'),
        ...
        $this->add_control(
                'likes_icon', array(
            'label' => esc_html__('Likes Icon', 'sparklestore-pro'),
            'type' => Controls_Manager::ICON,
            'label_block' => true,
            'file' => '',
            'default' => 'fa fa-heart',
        ...
        $this->add_responsive_control(
                'meta_item_margin', array(
            'label' => __('Item Margin', 'sparklestore-pro'),
            'type' => Controls_Manager::DIMENSIONS,
            'size_units' => array('px', '%'),
            'selectors' => array(
        ...
        $this->add_control(
                'show_on_hover', array(
            'label' => esc_html__('Show on hover', 'sparklestore-pro'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => esc_html__('Yes', 'sparklestore-pro'),
            'label_off' => esc_html__('No', 'sparklestore-pro'),
            'return_value' => 'yes',
        ...
        $this->add_control(
                'caption_order', array(
            'label' => esc_html__('Caption Order', 'sparklestore-pro'),
            'type' => Controls_Manager::NUMBER,
            'default' => 1,
            'min' => 1,
            'max' => 4,
        ...
        $this->add_control(
                'meta_order', array(
            'label' => esc_html__('Meta Order', 'sparklestore-pro'),
            'type' => Controls_Manager::NUMBER,
            'default' => 2,
            'min' => 1,
            'max' => 4,
        ...
        $this->add_control(
                'cover_alignment', array(
            'label' => esc_html__('Cover Content Vertical Alignment', 'sparklestore-pro'),
            'type' => Controls_Manager::SELECT,
            'default' => 'center',
            'options' => array(
                ...
                'space-between' => esc_html__('Space between', 'sparklestore-pro'),
            ),
            'selectors' => array(
    ...
    public function render_gallery() {
        ...
        if ('hashtag' === $settings['endpoint'] && empty($settings['hashtag'])) {
            return print esc_html__('Please, enter #hashtag.', 'sparklestore-pro');
        }

        if ('self' === $settings['endpoint'] && !$this->get_access_token()) {
            return print esc_html__('Please, enter Access Token.', 'sparklestore-pro');
        }
        ...
        if (!empty($posts)) {
            ...
            foreach ($posts as $post_data) {
                ...
                $item_html = sprintf(
                        '<div class="jet-instagram-gallery__media">%1$s</div><div class="jet-instagram-gallery__content">%2$s%3$s</div>', $the_image, $the_caption, $the_meta
                );
            ...
            $html .= sprintf(
                    '<div class="jet-instagram-gallery__item">%s</div>', esc_html__('Posts not found', 'sparklestore-pro')
            );
        }
    ...
    public function the_meta($item) {
        ...
        if ($this->config['post_comments_count']) {
            $meta_html .= sprintf(
                    '<div class="jet-instagram-gallery__meta-item jet-instagram-gallery__comments-count"><span class="jet-instagram-gallery__comments-icon jet-instagram-gallery__meta-icon"><i class="%s"></i></span><span class="jet-instagram-gallery__comments-label jet-instagram-gallery__meta-label">%s</span></div>', $this->get_settings_for_display('comments_icon'), $item['comments']
            );
        }

        if ($this->config['post_likes_count']) {
            $meta_html .= sprintf(
                    '<div class="jet-instagram-gallery__meta-item jet-instagram-gallery__likes-count"><span class="jet-instagram-gallery__likes-icon jet-instagram-gallery__meta-icon"><i class="%s"></i></span><span class="jet-instagram-gallery__likes-label jet-instagram-gallery__meta-label">%s</span></div>', $this->get_settings_for_display('likes_icon'), $item['likes']
            );
        }
    ...
    public function get_response_data($response) {
        ...
        $data = array();
        $nodes = array_slice(
                $response_items, 0, $this->config['posts_counter'], true
        );
    ...
    public function get_transient_key() {
        return sprintf('jet_elements_instagram_%s_%s_posts_count_%s_caption_%s', $this->config['endpoint'], $this->config['target'], $this->config['posts_counter'], $this->config['post_caption_length']
        );
    }
    ...
    public function get_access_token() {
        ...
        if (!$this->access_token) {
            $this->access_token = of_get_option('insta_access_token', '');
        }

...
class Jet_Elements_Video extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Video Player', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_video',
			array(
				'label' => esc_html__( 'Video', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_control(
			'video_type',
			array(
				'label'   => esc_html__( 'Video Type', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'youtube',
				'options' => array(
					'youtube'     => esc_html__( 'YouTube', 'sparklestore-pro' ),
					'vimeo'       => esc_html__( 'Vimeo', 'sparklestore-pro' ),
					'self_hosted' => esc_html__( 'Self Hosted', 'sparklestore-pro' ),
				),
			)
		);
		...
		$this->add_control(
			'youtube_url',
			array(
				'label'       => esc_html__( 'YouTube URL', 'sparklestore-pro' ),
				'label_block' => true,
				'type'        => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Enter your URL', 'sparklestore-pro' ),
		...
		$this->add_control(
			'vimeo_url',
			array(
				'label'       => esc_html__( 'Vimeo URL', 'sparklestore-pro' ),
				'label_block' => true,
				'type'        => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Enter your URL', 'sparklestore-pro' ),
		...
		$this->add_control(
			'self_hosted_player',
			array(
				'label'   => esc_html__( 'Player', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'html5',
				'options' => array(
					'html5' => esc_html__( 'Default HTML5', 'sparklestore-pro' ),
					'mejs'  => esc_html__( 'MediaElement Player', 'sparklestore-pro' ),
				),
				'condition' => array(
		...
		$this->add_control(
			...
			array(
				...
				'raw'  => esc_html__( 'MediaElement Player support MP4 and WebM video formats', 'sparklestore-pro' ),
		...
		$this->add_control(
			'self_hosted_url',
			array(
				'label'      => esc_html__( 'Self Hosted URL', 'sparklestore-pro' ),
		...
		$this->add_control(
			'start_time',
			array(
				'label'       => esc_html__( 'Start Time (in seconds)', 'sparklestore-pro' ),
				'label_block' => true,
		...
		$this->add_control(
			'end_time',
			array(
				'label'       => esc_html__( 'End Time (in seconds)', 'sparklestore-pro' ),
				'label_block' => true,
				'type'        => Controls_Manager::NUMBER,
				'condition' => array(
					'loop' => '',
		...
		$this->add_control(
			'aspect_ratio',
			array(
				'label'   => esc_html__( 'Aspect Ratio', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => '16-9',
				'options' => array(
					'16-9' => '16:9',
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Video Options', 'sparklestore-pro' ),
		...
		$this->add_control(
			'controls',
			array(
				'label'     => esc_html__( 'Player Controls', 'sparklestore-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => esc_html__( 'Show', 'sparklestore-pro' ),
				'label_off' => esc_html__( 'Hide', 'sparklestore-pro' ),
				'default'   => 'yes',
				'condition' => array(
					'video_type!' => 'vimeo',
				),
		...
		$this->add_control(
			'yt_modestbranding',
			array(
				'label'     => esc_html__( 'Modest Branding', 'sparklestore-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'default'   => '',
				'condition' => array(
					'video_type' => 'youtube',
		...
		$this->add_control(
			'yt_info',
			array(
				'label'     => esc_html__( 'Info', 'sparklestore-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => esc_html__( 'Show', 'sparklestore-pro' ),
				'label_off' => esc_html__( 'Hide', 'sparklestore-pro' ),
				'default'   => '',
		...
		$this->add_control(
			'yt_suggested_videos',
			array(
				'label'     => esc_html__( 'Suggested Videos', 'sparklestore-pro' ),
				'type'      => Controls_Manager::SWITCHER,
				'label_on'  => esc_html__( 'Show', 'sparklestore-pro' ),
				'label_off' => esc_html__( 'Hide', 'sparklestore-pro' ),
				'default'   => '',
		...
		$this->add_control(
			'yt_privacy_mode',
			array(
				'label'       => esc_html__( 'Privacy Mode', 'sparklestore-pro' ),
				'type'        => Controls_Manager::SWITCHER,
				'description' => esc_html__( 'When you turn on privacy mode, YouTube won\'t store information about visitors on your website unless they play the video.', 'sparklestore-pro' ),
				'default'     => '',
				'condition'   => array(
					'video_type' => 'youtube',
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Controls Color', 'sparklestore-pro' ),
		...
		$this->add_control(
			'mejs_controls',
			array(
				'label'       => esc_html__( 'Controls Visibility', 'sparklestore-pro' ),
				'label_block' => true,
				'type'        => Controls_Manager::SELECT2,
				'multiple'    => true,
				'options' => array(
					'current'    => esc_html__( 'Current Time', 'sparklestore-pro' ),
					'duration'   => esc_html__( 'Duration Time', 'sparklestore-pro' ),
					'volume'     => esc_html__( 'Volume', 'sparklestore-pro' ),
					'fullscreen' => esc_html__( 'Fullscreen Button', 'sparklestore-pro' ),
				),
		...
		$this->add_control(
			'download_button',
			array(
				'label'       => esc_html__( 'Download Button', 'sparklestore-pro' ),
				'description' => esc_html__( 'If browser supports', 'sparklestore-pro' ),
				'type'        => Controls_Manager::SWITCHER,
				'label_on'    => esc_html__( 'Show', 'sparklestore-pro' ),
				'label_off'   => esc_html__( 'Hide', 'sparklestore-pro' ),
				'default'     => '',
		...
		$this->add_control(
			'poster',
			array(
				'label' => esc_html__( 'Poster', 'sparklestore-pro' ),
				'type'  => Controls_Manager::MEDIA,
				'condition' => array(
					'video_type' => 'self_hosted',
				),
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Thumbnail Overlay', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_control(
			'show_thumbnail',
			array(
				'label'   => esc_html__( 'Show Custom Thumbnail', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => '',
			)
		);
		...
		$this->add_control(
			'thumbnail',
			array(
				'label' => esc_html__( 'Thumbnail', 'sparklestore-pro' ),
				'type'  => Controls_Manager::MEDIA,
				'condition' => array(
					'show_thumbnail' => 'yes',
				),
		...
		$this->add_control(
			'overlay_color',
			array(
				'label' => esc_html__( 'Overlay Color', 'sparklestore-pro' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->start_controls_section(
			'section_play_button',
			array(
				'label' => esc_html__( 'Play Button', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_control(
			'show_play_button',
			array(
				'label' => esc_html__( 'Show Play Button', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SWITCHER,
				'default' => 'yes',
			)
		);
		...
		$this->add_control(
			'play_button_type',
			array(
				'label'   => esc_html__( 'Play Button Type', 'sparklestore-pro' ),
				'type'    => Controls_Manager::CHOOSE,
				'default' => 'icon',
				'toggle'  => false,
				'options' => array(
					'icon' => array(
						'title' => esc_html__( 'Icon', 'sparklestore-pro' ),
						'icon'  => 'fa fa-play',
					),
					'image' => array(
						'title' => esc_html__( 'Image', 'sparklestore-pro' ),
		...
		$this->add_responsive_control(
			'play_button_size',
			array(
				'label' => esc_html__( 'Icon/Image Size', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 10,
		...
		$this->add_control(
			...
			array(
				'label'      => esc_html__( 'Image Border Radius', 'sparklestore-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Player Controls Container', 'sparklestore-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'video_type' => 'self_hosted',
					'self_hosted_player' => 'mejs',
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Player Play-Pause Button and Time', 'sparklestore-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'video_type' => 'self_hosted',
					'self_hosted_player' => 'mejs',
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Play-Pause Button', 'sparklestore-pro' ),
				'type'  => Controls_Manager::HEADING,
			)
		);
		...
		$this->add_control(
			'time_heading',
			array(
				'label'     => esc_html__( 'Time', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_responsive_control(
			'current_time_margin',
			array(
				'label'      => esc_html__( 'Current Time Margin', 'sparklestore-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Duration Time Margin', 'sparklestore-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Player Progress', 'sparklestore-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'video_type' => 'self_hosted',
					'self_hosted_player' => 'mejs',
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Total Progress Bar', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Height', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Current Progress Bar', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Player Volume', 'sparklestore-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'video_type' => 'self_hosted',
					'self_hosted_player' => 'mejs',
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Volume Button', 'sparklestore-pro' ),
				'type'  => Controls_Manager::HEADING,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Volume Slider', 'sparklestore-pro' ),
				'type'  => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Total Volume Bar', 'sparklestore-pro' ),
				'type'  => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Current Volume Bar', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Player Fullscreen Button', 'sparklestore-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => array(
					'video_type' => 'self_hosted',
					'self_hosted_player' => 'mejs',

...
class Jet_Elements_Progress_Bar extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Progress Bar', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default' => 'type-1',
				'options' => array(
					'type-1' => esc_html__( 'Inside the bar', 'sparklestore-pro' ),
					'type-2' => esc_html__( 'Placed above ', 'sparklestore-pro' ),
					'type-3' => esc_html__( 'Shown as tip', 'sparklestore-pro' ),
					'type-4' => esc_html__( 'On the right', 'sparklestore-pro' ),
					'type-5' => esc_html__( 'Inside the empty bar', 'sparklestore-pro' ),
					'type-6' => esc_html__( 'Inside the bar with title', 'sparklestore-pro' ),
					'type-7' => esc_html__( 'Inside the vertical bar', 'sparklestore-pro' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'placeholder' => esc_html__( 'Enter your title', 'sparklestore-pro' ),
		...
		$this->add_control(
			'percent',
			array(
				'label'       => esc_html__( 'Percentage', 'sparklestore-pro' ),
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Progress Height', 'sparklestore-pro' ),
		...
		$this->add_responsive_control(
			...
			array(
				'label'      => esc_html__( 'Progress Width', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px',
				),
		...
		$this->add_control(
			'status_bar_heading',
			array(
				'label' => esc_html__( 'Status Bar', 'sparklestore-pro' ),
		...
		$this->add_responsive_control(
			'title_alignment',
			array(
				'label'       => esc_html__( 'Title Alignment', 'sparklestore-pro' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Percent', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_responsive_control(
			'percent_width',
			array(
				'label'      => esc_html__( 'Percent Width', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array(
					'px',
				),
		...
		$this->add_responsive_control(
			'percent_alignment',
			array(
				'label'       => esc_html__( 'Percent Alignment', 'sparklestore-pro' ),
				'type'        => Controls_Manager::CHOOSE,
				'label_block' => false,
				'default'     => '',
				'options'     => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label'       => esc_html__( 'Percent Suffix Alignment', 'sparklestore-pro' ),
				'type'        => Controls_Manager::CHOOSE,
				'label_block' => false,
				'default'     => 'center',
				'options'     => array(

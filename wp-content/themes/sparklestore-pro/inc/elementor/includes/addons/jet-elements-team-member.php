...
class Jet_Elements_Team_Member extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Team Member', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'member_image',
			array(
				'label'   => esc_html__( 'Member Image', 'sparklestore-pro' ),
		...
		$this->add_control(
			'member_first_name',
			array(
				'label'   => esc_html__( 'First Name', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'John', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$this->add_control(
			'member_last_name',
			array(
				'label'   => esc_html__( 'Last Name', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Borthwick', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Name HTML Tag', 'sparklestore-pro' ),
		...
		$this->add_control(
			...
			array(
				...
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Position', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default' => esc_html__( 'Team member personal information', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$repeater->add_control(
			...
			array(
				...
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Label', 'sparklestore-pro' ),
			)
		);
		...
		$repeater->add_control(
			'label_visible',
			array(
				'label'        => esc_html__( 'Label visible', 'sparklestore-pro' ),
			...
			array(
				...
				'default' => array(
					array(
						...
						'social_label'  => esc_html__( 'Facebook', 'sparklestore-pro' ),
						'social_link'   => '#',
						'label_visible' => 'false',
					),
					array(
						'social_icon'   => 'fa fa-google-plus',
						'social_label'  => esc_html__( 'google+', 'sparklestore-pro' ),
						'social_link'   => '#',
						'label_visible' => 'false',
					),
					array(
						'social_icon'   => 'fa fa-twitter',
						'social_label'  => esc_html__( 'Twitter', 'sparklestore-pro' ),
						'social_link'   => '#',
						'label_visible' => 'false',
					),
				),
		...
		$this->add_control(
			'cover_like_hint',
			array(
				'label'        => esc_html__( 'Overlay like a hint', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'yes',
		...
		$this->add_responsive_control(
			'cover_height',
			array(
				'label'      => esc_html__( 'Overlay Height', 'sparklestore-pro' ),
		...
		$this->add_control(
			'use_hint_corner',
			array(
				'label'        => esc_html__( 'Use hint corner', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'hint_corner_color',
			array(
				'label'   => esc_html__( 'Corner Color', 'sparklestore-pro' ),
		...
		$this->add_control(
			'custom_image_size',
			array(
				'label'        => esc_html__( 'Custom size', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'name_cover_location',
			array(
				'label'        => esc_html__( 'Display in cover', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'yes',
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Social', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Items Spacing', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
		...
		$this->add_control(
			'social_order',
			array(
				'label'   => esc_html__( 'Social Order', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 4,
				'min'     => 1,
				'max'     => 5,

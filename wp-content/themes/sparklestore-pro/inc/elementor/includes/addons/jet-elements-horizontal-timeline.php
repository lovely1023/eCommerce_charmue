...
class Jet_Elements_Horizontal_Timeline extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Horizontal Timeline', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			'show_item_image',
			array(
				'label'   => esc_html__( 'Show Image', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => '',
			)
		);
		...
		$repeater->add_control(
			'item_point',
			array(
				'label'     => esc_html__( 'Point', 'sparklestore-pro' ),
		...
		$repeater->add_control(
			'item_point_type',
			array(
				'label'   => esc_html__( 'Point Content Type', 'sparklestore-pro' ),
		...
		$repeater->add_control(
			'item_point_icon',
			array(
				'label'       => esc_html__( 'Point Icon', 'sparklestore-pro' ),
		...
		$repeater->add_control(
			'item_point_text',
			array(
				'label'     => esc_html__( 'Point Text', 'sparklestore-pro' ),
				'type'      => Controls_Manager::TEXT,
				'default'   => 'A',
				'condition' => array(
		...
		$this->add_control(
			...
			array(
				...
				'default'     => array(
					array(
						'is_item_active'  => 'yes',
						'item_title'      => esc_html__( 'Card #1', 'sparklestore-pro' ),
						...
						'item_meta'       => esc_html__( 'Thursday, August 31, 2018', 'sparklestore-pro' ),
					),
					array(
						'item_title'      => esc_html__( 'Card #2', 'sparklestore-pro' ),
						'item_title_icon' => 'fa fa-birthday-cake',
						'item_desc'       => esc_html__( 'Lorem ipsum dolor sit amet, mea ei viderer probatus consequuntur, sonet vocibus lobortis has ad. Eos erant indoctum an, dictas invidunt est ex, et sea consulatu torquatos. Nostro aperiam petentium eu nam, mel debet urbanitas ad, idque complectitur eu quo. An sea autem dolore dolores.', 'sparklestore-pro' ),
						'item_point_icon' => 'fa fa-calendar',
						'item_meta'       => esc_html__( 'Thursday, August 29, 2018', 'sparklestore-pro' ),
					),
					array(
						'item_title'      => esc_html__( 'Card #3', 'sparklestore-pro' ),
						'item_title_icon' => 'fa fa-birthday-cake',
						'item_desc'       => esc_html__( 'Lorem ipsum dolor sit amet, mea ei viderer probatus consequuntur, sonet vocibus lobortis has ad. Eos erant indoctum an, dictas invidunt est ex, et sea consulatu torquatos. Nostro aperiam petentium eu nam, mel debet urbanitas ad, idque complectitur eu quo. An sea autem dolore dolores.', 'sparklestore-pro' ),
						'item_point_icon' => 'fa fa-calendar',
						'item_meta'       => esc_html__( 'Thursday, August 28, 2018', 'sparklestore-pro' ),
					),
					array(
						'item_title'      => esc_html__( 'Card #4', 'sparklestore-pro' ),
						'item_title_icon' => 'fa fa-birthday-cake',
						'item_desc'       => esc_html__( 'Lorem ipsum dolor sit amet, mea ei viderer probatus consequuntur, sonet vocibus lobortis has ad. Eos erant indoctum an, dictas invidunt est ex, et sea consulatu torquatos. Nostro aperiam petentium eu nam, mel debet urbanitas ad, idque complectitur eu quo. An sea autem dolore dolores.', 'sparklestore-pro' ),
						'item_point_icon' => 'fa fa-calendar',
						'item_meta'       => esc_html__( 'Thursday, August 27, 2018', 'sparklestore-pro' ),
					),
				),
		...
		$this->add_control(
			'show_card_arrows',
			array(
				'label'   => esc_html__( 'Show Card Arrows', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
			)
		);
		...
		$this->start_controls_section(
			'section_layout',
			array(
				'label' => esc_html__( 'Layout', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					...
					'chess' => array(
						'title' => esc_html__( 'Chess', 'sparklestore-pro' ),
		...
		$this->add_control(
			'navigation_type',
			array(
				'label'   => esc_html__( 'Navigation Type', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'scroll-bar',
				'options' => array(
					'scroll-bar' => esc_html__( 'Scroll Bar', 'sparklestore-pro' ),
					'arrows-nav' => esc_html__( 'Arrows Navigation', 'sparklestore-pro' ),
				)
			)
		);
		...
		$this->add_control(
			'arrow_type',
			array(
				'label'   => esc_html__( 'Arrow Type', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
		...
		$this->add_responsive_control(
			'items_gap',
			array(
				'label' => esc_html__( 'Items Gap', 'sparklestore-pro' ),
		...
		$this->start_controls_section(
			'section_cards_style',
			array(
				'label' => esc_html__( 'Cards', 'sparklestore-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_responsive_control(
			'cards_spacing',
			array(
				'label' => esc_html__( 'Spacing', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
		...
		$this->add_control(
			'cards_arrow_heading',
			array(
				'label'     => esc_html__( 'Arrow', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => array(
		...
		$this->start_controls_section(
			'section_image_style',
			array(
				'label' => esc_html__( 'Cards Content', 'sparklestore-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			'image_stretch',
			array(
				'label'   => esc_html__( 'Stretch Image', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => '',
				'selectors'  => array(
		...
		$this->add_control(
			'orders_heading',
			array(
				'label'     => esc_html__( 'Orders', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_responsive_control(
			'point_size',
			array(
				'label' => esc_html__( 'Point Size', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 10,
		...
		$this->start_controls_section(
			'section_line_style',
			array(
				'label' => esc_html__( 'Line', 'sparklestore-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Line Color', 'sparklestore-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
...
//			array(
//				'label'     => esc_html__( 'Progress Color', 'sparklestore-pro' ),
//				'type'      => Controls_Manager::COLOR,
//				'selectors' => array(
...
//		);
		...
		$this->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Scrollbar', 'sparklestore-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition' => array(
		...
		$this->add_control(
			...
			array(
				...
				'raw'  => esc_html__( 'Currently works only in -webkit- browsers', 'sparklestore-pro' ),
		...
		$this->add_control(
			'scrollbar_bg',
			array(
				'label'     => esc_html__( 'Scrollbar Color', 'sparklestore-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			'scrollbar_thumb_bg',
			array(
				'label'     => esc_html__( 'Scrollbar Thumb Color', 'sparklestore-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_control(
			'scrollbar_height',
			array(
				'label' => esc_html__( 'Scrollbar Height', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 1,
		...
		$this->add_control(
			'scrollbar_offset',
			array(
				'label' => esc_html__( 'Scrollbar Offset', 'sparklestore-pro' ),
				'type'  => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,

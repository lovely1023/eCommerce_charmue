...
class Jet_Elements_Countdown_Timer extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Countdown Timer', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'due_date',
			array(
				'label'       => esc_html__( 'Due Date', 'sparklestore-pro' ),
				'type'        => Controls_Manager::DATE_TIME,
				'default'     => $default_date,
				'description' => sprintf(
					esc_html__( 'Date set according to your timezone: %s.', 'sparklestore-pro' ),
		...
		$this->add_control(
			'show_days',
			array(
				'label'        => esc_html__( 'Days', 'sparklestore-pro' ),
		...
		$this->add_control(
			'label_days',
			array(
				'label'       => esc_html__( 'Days Label', 'sparklestore-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Days', 'sparklestore-pro' ),
				'placeholder' => esc_html__( 'Days', 'sparklestore-pro' ),
				'condition'   => array(
					'show_days'      => 'yes',
				),
			)
		...
		$this->add_control(
			'show_hours',
			array(
				'label'        => esc_html__( 'Hours', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'Hide', 'sparklestore-pro' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'label_hours',
			array(
				'label'       => esc_html__( 'Hours Label', 'sparklestore-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Hours', 'sparklestore-pro' ),
				'placeholder' => esc_html__( 'Hours', 'sparklestore-pro' ),
				'condition'   => array(
					'show_hours'      => 'yes',
				),
			)
		...
		$this->add_control(
			'show_min',
			array(
				'label'        => esc_html__( 'Minutes', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'Hide', 'sparklestore-pro' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'label_min',
			array(
				'label'       => esc_html__( 'Minutes Label', 'sparklestore-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Minutes', 'sparklestore-pro' ),
				'placeholder' => esc_html__( 'Minutes', 'sparklestore-pro' ),
				'condition'   => array(
					'show_min'      => 'yes',
				),
			)
		...
		$this->add_control(
			'show_sec',
			array(
				'label'        => esc_html__( 'Seconds', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'Hide', 'sparklestore-pro' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'label_sec',
			array(
				'label'       => esc_html__( 'Seconds Label', 'sparklestore-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Seconds', 'sparklestore-pro' ),
				'placeholder' => esc_html__( 'Seconds', 'sparklestore-pro' ),
				'condition'   => array(
					'show_sec'      => 'yes',
				),
			)
		...
		$this->add_control(
			'blocks_sep',
			array(
				'label'       => esc_html__( 'Blocks Separator', 'sparklestore-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '',
				'placeholder' => ':',
			)
		...
		$this->add_control(
			'items_size',
			array(
				'label'   => esc_html__( 'Items Size', 'sparklestore-pro' ),
		...
		$this->add_responsive_control(
			'item_padding',
			array(
				'label'      => esc_html__( 'Item Padding', 'sparklestore-pro' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Labels', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Digits', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			'digit_item_heading',
			array(
				'label'     => esc_html__( 'Digit Item Styles', 'sparklestore-pro' ),
		...
		$this->start_controls_section(
			'section_sep_styles',
			array(
				'label'      => esc_html__( 'Separator Styles', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			'sep_font',
			array(
				'label'     => esc_html__( 'Font', 'sparklestore-pro' ),
		...
		$this->add_control(
			'value_order',
			array(
				'label'   => esc_html__( 'Digit Order', 'sparklestore-pro' ),
		...
		$this->add_control(
			'label_order',
			array(
				'label'   => esc_html__( 'Label Order', 'sparklestore-pro' ),
				'type'    => Controls_Manager::NUMBER,
				'default' => 2,
				'min'     => 1,
				'max'     => 2,

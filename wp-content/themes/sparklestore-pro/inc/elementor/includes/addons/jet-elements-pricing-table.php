...
class Jet_Elements_Pricing_Table extends Jet_Elements_Base {
	...
	public function get_title() {
		return esc_html__( 'Pricing Table', 'sparklestore-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'default' => esc_html__( 'Title', 'sparklestore-pro' ),
		...
		$this->add_control(
			'subtitle',
			array(
				'label'   => esc_html__( 'Subtitle', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Subtitle', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$this->add_control(
			'featured',
			array(
				'label'        => esc_html__( 'Is Featured?', 'sparklestore-pro' ),
		...
		$this->add_control(
			'featured_badge',
			array(
				'label'   => esc_html__( 'Featured Badge', 'sparklestore-pro' ),
		...
		$this->add_control(
			'featured_position',
			array(
				'label'   => esc_html__( 'Featured Position', 'sparklestore-pro' ),
		...
		$this->add_responsive_control(
			'featured_left',
			array(
				'label'      => esc_html__( 'Left Indent', 'sparklestore-pro' ),
		...
		$this->add_responsive_control(
			'featured_right',
			array(
				'label'      => esc_html__( 'Right Indent', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%', 'em' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_responsive_control(
			'featured_top',
			array(
				'label'      => esc_html__( 'Top Indent', 'sparklestore-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%', 'em' ),
				'range'      => array(
					'px' => array(
		...
		$this->add_control(
			'price_prefix',
			array(
				'label'   => esc_html__( 'Price Prefix', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( '$', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$this->add_control(
			'price',
			array(
				'label'   => esc_html__( 'Price Value', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( '100', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$this->add_control(
			'price_suffix',
			array(
				'label'   => esc_html__( 'Price Suffix', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( '/per month', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$this->add_control(
			'price_desc',
			array(
				'label' => esc_html__( 'Price Description', 'sparklestore-pro' ),
		...
		$this->start_controls_section(
			'section_features',
			array(
				'label' => esc_html__( 'Features', 'sparklestore-pro' ),
			)
		);
		...
		$repeater->add_control(
			...
			array(
				...
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Feature', 'sparklestore-pro' ),
				'dynamic' => array( 'active' => true ),
			)
		);
		...
		$repeater->add_control(
			'item_included',
			array(
				'label'   => esc_html__( 'Is Included?', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'item-included',
				'options' => array(
					'item-included'=> esc_html__( 'Included', 'sparklestore-pro' ),
					'item-excluded' => esc_html__( 'Excluded', 'sparklestore-pro' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'default' => array(
					array(
						'item_text'     => esc_html__( 'Feature #1', 'sparklestore-pro' ),
						'item_included' => 'item-included',
					),
					array(
						'item_text'     => esc_html__( 'Feature #2', 'sparklestore-pro' ),
						'item_included' => 'item-included',
					),
					array(
						'item_text'     => esc_html__( 'Feature #3', 'sparklestore-pro' ),
						'item_included' => 'item-excluded',
					),
					array(
						'item_text'     => esc_html__( 'Feature #4', 'sparklestore-pro' ),
						'item_included' => 'item-excluded',
					),
				),
		...
		$this->start_controls_section(
			'section_action',
			array(
				'label' => esc_html__( 'Action Button', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_control(
			'button_before',
			array(
				'label'   => esc_html__( 'Text Before Action Button', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Buy', 'sparklestore-pro' ),
			)
		);
		...
		$this->add_control(
			'button_after',
			array(
				'label'   => esc_html__( 'Text After Action Button', 'sparklestore-pro' ),
				'type'    => Controls_Manager::TEXT,
				'default' => '',
			)
		);
		...
		$this->start_controls_section(
			'section_table_style',
			array(
				'label'      => esc_html__( 'Table', 'sparklestore-pro' ),
		...
		$this->add_responsive_control(
			'table_padding',
			array(
				'label'      => esc_html__( 'Table Padding', 'sparklestore-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Header', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			'subtitle_color',
			array(
				'label'  => esc_html__( 'Subtitle Color', 'sparklestore-pro' ),
				'type'   => Controls_Manager::COLOR,
				'scheme' => array(
					'type'  => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_2,
		...
		$this->add_responsive_control(
			'header_padding',
			array(
				'label'      => esc_html__( 'Header Padding', 'sparklestore-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->add_group_control(
			...
			array(
				'name'           => 'icon_style',
				'label'          => esc_html__( 'Icon Style', 'sparklestore-pro' ),
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Pricing', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			'price_prefix_style',
			array(
				'label'     => esc_html__( 'Prefix', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'price_prefix_color',
			array(
				'label' => esc_html__( 'Price Prefix Color', 'sparklestore-pro' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => array(
					'type'  => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Prefix Display', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'inline-block' => esc_html__( 'Inline', 'sparklestore-pro' ),
					'block'        => esc_html__( 'Block', 'sparklestore-pro' ),
				),
		...
		$this->add_control(
			'price_color',
			array(
				'label' => esc_html__( 'Price Color', 'sparklestore-pro' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => array(
					'type'  => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
		...
		$this->add_control(
			'price_suffix_style',
			array(
				'label'     => esc_html__( 'Suffix', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'price_suffix_color',
			array(
				'label' => esc_html__( 'Price Suffix Color', 'sparklestore-pro' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => array(
					'type'  => Scheme_Color::get_type(),
					'value' => Scheme_Color::COLOR_1,
		...
		$this->add_control(
			...
			array(
				'label'   => esc_html__( 'Suffix Display', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'inline-block' => esc_html__( 'Inline', 'sparklestore-pro' ),
					'block'        => esc_html__( 'Block', 'sparklestore-pro' ),
		...
		$this->add_control(
			'price_desc_color',
			array(
				'label' => esc_html__( 'Price Description Color', 'sparklestore-pro' ),
				'type'  => Controls_Manager::COLOR,
				'selectors' => array(
		...
		$this->add_responsive_control(
			'price_padding',
			array(
				'label'      => esc_html__( 'Pricing Block Padding', 'sparklestore-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->add_responsive_control(
			'features_padding',
			array(
				'label'      => esc_html__( 'Features Block Padding', 'sparklestore-pro' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => array( 'px', '%', 'em' ),
				'selectors'  => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Included Feature', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__( 'Included Bullet Icon', 'sparklestore-pro' ),
				'type'        => Controls_Manager::ICON,
				'label_block' => true,
				'file'        => '',
				'default'     => 'fa fa-check',
		...
		$this->add_control(
			'inc_bullet_color',
			array(
				'label' => esc_html__( 'Bullet Color', 'sparklestore-pro' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => array(
					'type'  => Scheme_Color::get_type(),
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Excluded Feature', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__( 'Excluded Bullet Icon', 'sparklestore-pro' ),
				'type'        => Controls_Manager::ICON,
				'label_block' => true,
				'file'        => '',
				'default'     => 'fa fa-times',
		...
		$this->add_control(
			'exc_text_decoration',
			array(
				'label'   => esc_html__( 'Text Decoration', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'none',
				'options' => array(
					'none'         => esc_html__( 'None', 'sparklestore-pro' ),
					'line-through' => esc_html__( 'Line Through', 'sparklestore-pro' ),
				),
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Features Divider', 'sparklestore-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->start_controls_section(
			...
			array(
				'label'      => esc_html__( 'Action Box', 'sparklestore-pro' ),
				'tab'        => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			)
		);
		...
		$this->add_control(
			'button_size',
			array(
				'label'   => esc_html__( 'Size', 'sparklestore-pro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'auto',
				'options' => array(
					'auto' => esc_html__( 'auto', 'sparklestore-pro' ),
					'full'  => esc_html__( 'full', 'sparklestore-pro' ),
				),
			)
		);
		...
		$this->add_control(
			'add_button_icon',
			array(
				'label'        => esc_html__( 'Add Icon', 'sparklestore-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Yes', 'sparklestore-pro' ),
				'label_off'    => esc_html__( 'No', 'sparklestore-pro' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			...
			array(
				...
				'type'    => Controls_Manager::SELECT,
				'options' => array(
					'left'  => esc_html__( 'Before Text', 'sparklestore-pro' ),
					'right' => esc_html__( 'After Text', 'sparklestore-pro' ),
				),
				'default'     => 'left',
		...
		$this->add_group_control(
			...
			array(
				...
				'fields_options' => array(
					...
					'color' => array(
						'label'  => _x( 'Background Color', 'Background Control', 'sparklestore-pro' ),
						'scheme' => array(
							'type'  => Scheme_Color::get_type(),
							'value' => Scheme_Color::COLOR_1,
						),
					...
					'color_b' => array(
						'label' => _x( 'Second Background Color', 'Background Control', 'sparklestore-pro' ),
					),
				),
				'exclude' => array(
					'image',

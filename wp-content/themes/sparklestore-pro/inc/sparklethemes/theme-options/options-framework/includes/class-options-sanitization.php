...
function of_recognized_background_repeat() {
    $default = array(
        'no-repeat' => __('No Repeat', 'sparklestore-pro'),
        'repeat-x' => __('Repeat Horizontally', 'sparklestore-pro'),
        'repeat-y' => __('Repeat Vertically', 'sparklestore-pro'),
        'repeat' => __('Repeat All', 'sparklestore-pro'),
    );
...
function of_recognized_background_position() {
    $default = array(
        'top left' => __('Top Left', 'sparklestore-pro'),
        'top center' => __('Top Center', 'sparklestore-pro'),
        'top right' => __('Top Right', 'sparklestore-pro'),
        'center left' => __('Middle Left', 'sparklestore-pro'),
        'center center' => __('Middle Center', 'sparklestore-pro'),
        'center right' => __('Middle Right', 'sparklestore-pro'),
        'bottom left' => __('Bottom Left', 'sparklestore-pro'),
        'bottom center' => __('Bottom Center', 'sparklestore-pro'),
        'bottom right' => __('Bottom Right', 'sparklestore-pro')
    );
...
function of_recognized_background_attachment() {
    $default = array(
        'scroll' => __('Scroll Normally', 'sparklestore-pro'),
        'fixed' => __('Fixed in Place', 'sparklestore-pro')
    );
...
function of_recognized_font_styles() {
    $default = array(
        ...
        'italic' => __('Italic', 'sparklestore-pro'),
        'bold' => __('Bold', 'sparklestore-pro'),
        'bold italic' => __('Bold Italic', 'sparklestore-pro')
    );
